    ...
    <nav class="collapse navbar-collapse">
            ...
            <ul class="nav user-nav">
                ...
                <li class="user-avatar-li nav-hover">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="hidden-lg"><a href="/notification"><span class="pull-right num">6</span><i
                                class="es-icon es-icon-notificationson"></i>通知</a>
                        </li>
        ...
        <#else>
            ...
            <div class="navbar-form navbar-right hidden-xs hidden-sm">
                <div class="form-group">
                    <input class="form-control js-full-search" name="q" placeholder="搜内容" id="fulltext-query"
                           onkeypress="if(event.keyCode==13) {baidusearch('fulltext-query');}">
