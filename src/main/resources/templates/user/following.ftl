<!DOCTYPE html>
<!-- saved from url=(0043)/user/94/following -->
...
<div class="es-wrap">
    ...
    <div class="user-center-header has-blurr"
        ...
        <div class="blurr-bg"
             style="background: url(&quot;${(user.titleImgUrl)!}&quot;) center center / 150%; left: 0px; right: 0px; top: -50px; bottom: -50px; width: 1349px; filter: blur(60px); transform: translateZ(0px); position: absolute;"></div>
        <div class="container clearfix" style="position: absolute; left: 0px; right: 0px; z-index: 1;">
            <div class="user-avatar">
                ...
                <div class="position">
                    ...
                    <a href="http://dongxicheng.org/" target="_blank"><i class="es-icon es-icon-link"></i></a>
                </div>
                <div class="mates">
                    <span class="mrm">161</span>粉丝<span class="mlm mrm">｜</span><span class="mrm">2</span>关注
                </div>
                <div class="actions">
    ...
    <div id="content-container" class="container">
        ...
        <ul class="nav nav-pills mbl">
            <li class="active"><a href="/user/${(user.id)!}/following">关注</a></li>
            <li><a href="/user/${(user.id)!}/follower">粉丝</a></li>
        </ul>
                    ...
                    <div class="col-md-3">
                        <div class="teacher-item">
                            ...
                            <div class="teacher-bottom">
                                ...
                                <div class="metas">
                                    <a class="btn btn-primary btn-sm follow-btn" href="javascript:;" data-url="/user/${(user.id)!}/follow"
                                       data-loggedin="1">关注</a>
