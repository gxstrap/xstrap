...
!function (window, underfined) {
    var root, readyList = [], loadList = {}, core_strUndefined = "undefined", location = window.location,
        ...
        clearHtmlExp = /(<.*?>)/gi, nTalk = function (a, b) {
            return new nTalk.fn.init(a, b, root)
        }, readyComplete = !1, emptyFunc = function () {
        };
    nTalk.fn = nTalk.prototype = {
        talkVersion: core_version, constructor: nTalk, init: function (a, b, c) {
            var d, e;
            if (!a)return this;
            if ("string" == typeof a)return d = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : rQuickExpr.exec(a), !d || !d[1] && b ? !b || b.talkVersion ? (b || c).find(a) : this.constructor(b).find(a) : d[1] ? (b = b instanceof nTalk ? b[0] : b, nTalk.merge(this, nTalk.parseHTML(d[1], b && b.nodeType ? b.ownerDocument || b : document, !0)), this) : (e = document.getElementById(d[2]), e && e.parentNode && (this.length = 1, this[0] = e), this.context = document, this.selector = a, this);
            if (a.nodeType || nTalk.isWindow(a))return this.context = this[0] = a, this.length = 1, this;
            if (nTalk.isObject(a) && a.talkVersion)return a.length && (this.context = this[0] = a[0], this.length = 1), this;
            if (nTalk.isPlainObject(a)) {
                var f = a.tag || "div";
                return delete a.tag, this.context = this[0] = nTalk.Element(f, a), this.length = 1, this
            }
        ...
        var a, b, c, d, e, f = arguments[0] || {}, g = 1, h = arguments.length, i = !1;
        for ("boolean" == typeof f && (i = f, f = arguments[1] || {}, g = 2), "object" == typeof f || nTalk.isFunction(f) || (f = {}), h === g && (f = this, --g); g < h; g++)if (a = arguments[g])for (var j in a)a.hasOwnProperty(j) && (b = f[j], c = a[j], f !== c && (i && c && (nTalk.isPlainObject(c) || (d = nTalk.isArray(c))) ? (d ? (d = !1, e = b && nTalk.isArray(b) ? b : []) : e = b && nTalk.isPlainObject(b) ? b : {}, f[j] = nTalk.extend(i, e, c)) : void 0 !== c && (f[j] = c)));
        return f
    }, nTalk.extend({
        ...
        parseHTML: function (a, b) {
            ...
            if (/<|&#?\w+;/.test(a)) {
                ...
                return d.innerHTML = a, nTalk.merge([], d.childNodes)
            }
            return [b.createTextNode(a)]
        },
        merge: function () {
            var a, b, c, d = arguments[0] || {}, e = arguments;
            if (e.length <= 1)return d;
            for (a = 1; a < e.length; a++)if (e[a] && null !== e[a])if (void 0 === e[a].length)for (b in e[a])e[a].hasOwnProperty(b) && (d[b] = e[a][b]); else for (b = 0, c = e[a].length; b < c; b++)void 0 !== d.length ? d.push(e[a][b]) : d[b] = e[a][b];
            return d
        },
        each: function (a, b, c) {
            if (nTalk.isArray(c) || (c = []), nTalk.isArray(a) || nTalk.isObject(a) && a.talkVersion)for (var d = 0; d < a.length && b.apply(a[d], [d, a[d++]].concat(c)) !== !1;); else if (nTalk.isObject(a))for (var e in a)a.hasOwnProperty(e) && b.apply(a[e], [e, a[e]].concat(c)); else b.apply(a, [0, a].concat(c));
            return a
        },
        access: function (a, b, c, d, e) {
            ...
            } else if (void 0 !== d)for (e = !0; f < g; f++)b(a[f], c, d);
            return e ? a : g ? b(a[0], c) : null
        },
        strFormat: function (a, b) {
            for (var c = "", d = 1, e = b || 2; d <= e; d++)c += "0";
            return c += a || "", c.substr(c.length - e)
        },
        getTime: function (a) {
            var b = (new Date).getTime(), c = 1e3 * Math.random();
        ...
        secondsToMinutes: function (a) {
            var b = "", c = a, d = this.strFormat;
            return c >= 60 ? (b += d(Math.floor(c / 60)), c %= 60) : b += "00", b + ":" + d(c)
        },
        formatDate: function (a, b) {
            var c, d;
            this.isNumeric(a) ? c = new Date(a) : "string" == typeof a ? (c = new Date, b = a) : c = new Date, b = b || "HH:mm:ss", d = {
                "M+": c.getMonth() + 1,
                "d+": c.getDate(),
        ...
        randomChar: function (a, b) {
            for (var c = "", d = a || 8, e = 10 == b ? "0123456789" : "0123456789ABCDEF",
                     f = 0; f < d; f++)c += e.charAt(Math.round(Math.random() * (e.length - 1)));
            return c
        }
    }), nTalk.selector = {
        tagGuid: 1,
        ...
        query: function (a, b) {
            ...
            for (c = this.format(a), b = d, f = 0, g = c.length; f < g; f++) {
                for (a = c[f], e = (" " + a).match(this.rex.R_RULE), a = a.match(this.rex.NR_RULE), d = b, h = 0, i = e.length; h < i; h++)d = this.parse(a[h], d, e[h]);
                j = j.concat(d)
            }
        ...
        format: function (a) {
            var b = [], c = [];
            this.pseuParams = b, this.attrParams = c, a = a.replace(this.rex.TRIM_LR, "").replace(this.rex.TRIM_ALL, "$1").replace(this.rex.ATTR_PARAM, function (a) {
                return c.push(a) - 1
            });
            for (var d = function (a) {
                return b.push(a.substring(1, a.length - 1)) - 1
            }; a.indexOf("(") !== -1;)a = a.replace(this.rex.PSEU_PARAM, d);
            return a.split(",")
        },
        parse: function (a, b, c) {
            var d, e, f, g, h, i;
            return e = this.rex.RULES.exec(a), (f = e[1]) ? (f = document.getElementById(f.substring(1))) ? [f] : [] : (d = nTalk.selector.queryRelative[c](b, e[2] || "*", this), (g = e[3]) && (d = this.filterClass(d, g.replace(this.rex.CLS, ""))), (h = e[4]) && (d = this.filterAttr(d, this.getAttrRules(h.match(this.rex.ATTR_PARAM), this.attrParams))), (i = e[5]) && (d = this.filterPseudo(d, this.getPseudoRules(i.match(this.rex.PSEU), this.pseuParams))), d)
        },
        getRules: function (a) {
            var b, c, d;
            return b = this.rex.RULES.exec(a), b[2] || (b[2] = "*"), b[3] = b[3].replace(this.rex.CLS, ""), (c = b[4]) && (b[4] = this.getAttrRules(c.match(this.rex.ATTR_PARAM), this.attrParams)), (d = b[5]) && (b[5] = this.getPseudoRules(d.match(this.rex.PSEU), this.pseuParams)), b
        },
        getAttrRules: function (a, b) {
            for (var c, d, e = [], f = a.length, g = this.rex.ATTR,
                     h = 0; h < f; h++)c = b[a[h]], d = c.match(g) || " ", c = c.split(g), e.push(nTalk.selector.queryAttrs[d]), e.push(c);
            return e
        },
        getPseudoRules: function (a, b) {
            for (var c, d, e, f = [], g = 0, h = a.length, i = this.tagGuid++; g < h; g++) {
                ...
                f.push(nTalk.selector.queryPseudos[c]), f.push(d)
            }
            return f
        },
        filterPseudo: function (a, b) {
            for (var c, d, e, f, g = a.length, h = 0, i = b.length, j = []; h < g; h++) {
                for (d = a[h], c = 0; c < i && (e = b[c], f = b[c + 1], e && e(d, f, this)); c += 2);
                c === i && j.push(d)
            }
            return j
        },
        filterAttr: function (a, b) {
            for (var c, d, e, f, g, h, i = a.length, j = 0, k = b.length, l = []; j < i; j++) {
                for (d = a[j], c = 0; c < k && (f = b[c], e = b[c + 1], h = e[0], (g = "href" === h ? d.getAttribute(h) : d.getAttribute(h)) || (g = d[this.attrMap[h] || h])) && f(g + "", e[1]); c += 2);
                c === k && l.push(d)
            }
            return l
        },
        filterClass: function (a, b) {
            for (var c, d, e, f = 0, g = a.length,
                     h = []; f < g; f++)e = a[f], "string" == typeof e.className && (c = e.className, d = new RegExp(c.replace(" ", "|"), "g"), b.replace(d, "") || h.push(e));
            return h
        },
        filterEl: function (a, b, c, d, e) {
            return ("*" === b || a.nodeName.toLowerCase() === b) && (!(c && !this.filterClass([a], c).length) && (!(d && !this.filterAttr([a], d).length) && !(e && !this.filterPseudo([a], e).length)))
        },
        makeDiff: function (a) {
            for (var b, c, d = this.tagGuid++, e = a.length, f = [],
                     g = 0; g < e; g++)b = a[g], c = this.getElData(b), c.tagGuid !== d && (f.push(b), c.tagGuid = d);
            return f
        },
        getElData: function (a) {
            var b = a.mojoExpando;
            return b || (b = a.mojoExpando = {mQuery: {tagGuid: 0}}), (b = b.mQuery) || (b = {tagGuid: 0}), b
        },
        queryRelative: {
            " ": function (a, b, c) {
                for (var d, e, f, g, h, i = c.tagGuid++, j = a.length, k = [], l = 0; l < j; l++) {
                    if (g = a[l], h = g.parentNode) {
                        if (c.getElData(h).tagGuid === i)continue;
                        c.getElData(g).tagGuid = i
                    }
                    for (f = g.getElementsByTagName(b) || null, d = 0, e = f.length; d < e; d++)k.push(f[d])
                }
                return k
            }, ">": function (a, b) {
                for (var c, d = [], e = a.length,
                         f = 0; f < e; f++)for (c = a[f].firstChild; c;)1 === c.nodeType && (c.nodeName.toLowerCase() !== b && "*" !== b || d.push(c)), c = c.nextSibling;
                return d
            }, "+": function (a, b) {
                for (var c, d = [], e = a.length,
                         f = 0; f < e; f++)for (c = a[f]; c = c.nextSibling;)if (1 === c.nodeType) {
                    c.nodeName.toLowerCase() !== b && "*" !== b || d.push(c);
                    break
                }
                return d
            }, "~": function (a, b, c) {
                for (var d, e, f, g = c.tagGuid++, h = a.length, i = [], j = 0; j < h; j++) {
        ...
        queryPseudos: {
            eq: function (a, b, c) {
                ...
                if ((d = a.parentNode) && (h = c.getElData(d)).tagGuid !== b) {
                    for (f = d.firstChild, g = 1; f;)1 === f.nodeType && (c.getElData(f).nodeIndex = g++), f = f.nextSibling;
                    h.tagGuid = b
                }
                return e = c.getElData(a).nodeIndex, e == b
            }, lt: function (a, b, c) {
                var d, e, f, g, h;
                if ((d = a.parentNode) && (h = c.getElData(d)).tagGuid !== b) {
                    for (f = d.firstChild, g = 1; f;)1 === f.nodeType && (c.getElData(f).nodeIndex = g++), f = f.nextSibling;
                ...
                for (var b = a.nextSibling, c = a.previousSibling; b;) {
                ...
                return e = c.getElData(a).nodeIndex, b[1] ? (e -= b[3], b = b[2], e * b >= 0 && e % b === 0) : e === b[2]
            }, not: function (a, b, c) {
        ...
        initializeCore: function () {
            var a = /([^\.]+(\.com(\.cn)?|\.net(\.cn)?|\.edu(\.cn)?|\.org(\.cn)?|\.gov(\.cn)?|\.cn|\.mobi|\.tel|\.asia|\.me|\.info|\.hk|\.cc|\.biz|\.tv))$/i.exec(document.domain),
            ...
            for (var e, f = c.length ? c.substr(1).split("&") : ["lan=zh_cn", ""],
                     g = 0; g < f.length; g++)e = f[g].split("="), nTalk.extParmas[e[0]] = "lan" == e[0] ? e[1] || "zh_cn" : e[1];
            nTalk.cache.init()
        }
        ...
        var b = {
            ...
            d = /OS (\d)_.* like Mac OS X/g.exec(window.navigator.userAgent);
        nTalk.each(b, function (c) {
            b[c] = a.indexOf(c.toLowerCase()) > -1
        }), b.ua = a, b.ieversion = 0, b.coreversion = 0, b.mac = !!a.match(/cpu.+mac\s+os\s+x/g);
        for (var e = 0; e < c.length; e++)new RegExp(c[e], "i").test(a) && (e == c.length - 1 ? b.ieversion = RegExp.$1 || RegExp.$2 : b.coreversion = RegExp.$1);
        return b.ieversion = document.documentMode || b.ieversion || b.ieversion, b.msie = b.msie || b.ieversion > 0, b.gecko = b.gecko && !b.webkit && !b.msie, b.msie6 = b.msie && 6 == b.ieversion, b.msie7 = b.msie && 7 == b.ieversion, b.msie8 = b.msie && 8 == b.ieversion, b.msie9 = b.msie && 9 == b.ieversion, b.msie10 = b.msie && 10 == b.ieversion, b.msie11 = b.msie && 11 == b.ieversion, b.edge = b.edge, b.uc = b.uc, b.oldmsie = b.ieversion && b.ieversion <= 9, b.safari = b.safari && !b.chrome, b.safari2 = b.safari && !/adobeair/i.test(a), b.Quirks = "BackCompat" === document.compatMode, b.mobile = /mobile|android|linux/i.test(a), b.android = /android (\d.*?);/g.exec(a), b.oldAndroid = b.android && b.android.pop().substr(0, 3) < 4.5, b.oldIOS = !!d && +d.pop() < 8, b.iPhone6 = b.iPhone && 375 == document.body.offsetWidth, b.iPhone6Plus = b.iPhone && 414 == document.body.offsetWidth, b.iOS = "Mac68K" == navigator.platform || "MacPPC" == navigator.platform || "Macintosh" == navigator.platform || a.indexOf("mac") > -1, b.is = function (b) {
            return new RegExp(b, "ig").test(a)
        }, b.html5 = !!window.applicationCache, b.supportMqtt = "WebSocket" in window && null !== window.WebSocket && "localStorage" in window && null !== window.localStorage && "ArrayBuffer" in window && null !== window.ArrayBuffer, b
    }(navigator.userAgent.toLowerCase()), nTalk.extend({
        ready: function (a) {
            var b = this, c = document.readyState, d = nTalk.browser.webkit && nTalk.browser.version < 525,
                e = function () {
                    if (!readyComplete) {
                        !d && window.removeEventListener && (document.removeEventListener("DOMContentLoaded", e, !1), window.removeEventListener("load", e, !1)), nTalk.isReady = readyComplete = !0;
            ...
            if (readyComplete || /loaded|complete/gi.test(c) ? (nTalk.isReady = readyComplete = !0, a.call(b)) : readyList[readyList.length] = function () {
                ...
                /^loaded|complete$/i.test(c) ? e() : setTimeout(arguments.callee(), 50)
            }(); else if (document.addEventListener) "interactive" == c ? e() : (document.addEventListener("DOMContentLoaded", e, !1), window.addEventListener("load", e, !1)); else {
                var f = document.createElement("div");
                !function () {
                    (function () {
                        try {
                            f.doScroll("left"), document.body.insertBefore(f, document.body.lastChild).setAttribute("html", "temp")
                        } catch (a) {
                        }
                        return f
            ...
            a && (a = "string" == typeof a ? [a] : a, b = b || emptyFunc, c = c || document.head || nTalk("head")[0] || document.documentElement, e = nTalk._getObjectNumber(a), 0 === g.length && 0 === e && b.apply(i, h), nTalk.each(a, function (a, j) {
                if (j) {
                    var k, l = nTalk.getTime(), m = j.indexOf("?") == -1 ? "?" : "&",
                        n = j.replace(/(.*\/)?(.*?)[\?$](.*)?/i, "$2"), o = nTalk.isNumeric(a) ? "" : a,
                        p = function () {
                            g.splice(nTalk.inArray(j, g), 1), e--, 0 === g.length && 0 === e && b.apply(i, h)
                        }, q = function (a) {
                            a = nTalk.Event.fixEvent(a);
                            var b = a.currentTarget || a.srcElement, c = /loaded|complete/gi, d = b.readyState;
                            "load" === a.type || c.test(d) ? setTimeout(function () {
                                o ? (loadList[n] = nTalk[o], h.push(nTalk[o])) : (loadList[n] = b, h.push(b)), p()
                            }, nTalk.browser.msie6 ? 500 : 0) : "error" === a.type && (a.error = !0, h.push(!o && a), p())
                        };
                    g.push(j), n += j.indexOf("#rnd") > -1 ? String(l).substring(5, 11) : j.indexOf("#image") > -1 ? j.replace(/(.*?)\?(.*?)(#.*?)?$/gi, "-$2") : "", k = /\.((gif)|(png)|(jpg)|(bmp)|(jpeg))$/i.test(j) || /#image$/gi.test(j), isRobotImage = /#robotImg/gi.test(j), j = j.replace(/#rnd/i, m + "ts=" + l).replace(/#image/i, ""), f = (/^(https?:\/\/)/i.test(j) ? "" : nTalk.baseURI) + j, o && nTalk[o] ? (h.push(nTalk[o]), p()) : !o && loadList[n] ? (h.push(loadList[n]), p()) : k ? i = nTalk.preloadImage(f, function (a) {
                        a.error = !1, loadList[n] = a, h.push(a), p()
                    }, function (a) {
                        a.error = !0, h.push(a), p()
                    }, isRobotImage ? 120 : 6) : (d = /\.css[^\.]*$/gi.test(j) ? {
                        tag: "link",
                        type: "text/css",
                        rel: "stylesheet",
                        href: f
            ...
            a = a + (/\?/gi.test(a) ? "&" : "?") + "callback=" + d, window[d] = function () {
                c = arguments, setTimeout(function () {
            ...
            }, nTalk.require(a, function (a) {
                nTalk(a.error ? a.target : this).remove()
            })
        }, preloadImage: function (a, b, c, d) {
            var e = this;
            b = b || emptyFunc, c = c || emptyFunc;
            var f, g = new Image;
            return g.src = a, g.setAttribute("loadTime", 0), g.complete ? (b.call(nTalk, g), g) : (g.onload = function () {
                clearInterval(f), b.call(nTalk, this)
            }, g.onError = function () {
                clearInterval(f), c.call(nTalk, this)
            }, f = setInterval(function () {
                g.setAttribute("loadTime", parseInt(g.getAttribute("loadTime")) + 1), parseInt(g.getAttribute("loadTime"), 10) >= d && (clearInterval(f), c.call(nTalk, e)), ("complete" == g.readyState || nTalk.browser.msie7) && (clearInterval(f), g.onLoad = g.onError = null, b.call(nTalk, g))
            }, 500), g)
        ...
        enable: function () {
            var a = !1, b = "testcookie";
            return !!navigator.cookieEnabled || (this.set(b, "yes", 0), "yes" == this.get(b) && (a = !0), this.del(b), a)
        }, set: function (a, b, c, d) {
            var e, f, g, h;
            return b = b || "", d = d ? d : nTalk.domain, "number" != typeof c && (c = 0), 0 === c ? f = nTalk.browser.msie || nTalk.browser.mobile ? " " : "expires=0; " : (e = new Date, e.setTime(e.getTime() + c), f = e ? "expires=" + e.toGMTString() + "; " : ""), d = "domain=" + d + "; ", g = a + "=" + ("" + b).replace(/\"|\'/gi, "|") + "; ", h = "path=/; ", document.cookie = g + f + d + h, b
        }, get: function (a) {
        ...
        function gt(a) {
            var b = version, c = (a || "0.0.0").split(".").slice(0, 3);
        ...
        return {
            remove: fnRemove,
            GT: gt,
            support: !((0 === version.join(".").indexOf("11.6.602") || 0 === version.join(".").indexOf("11.3.300") || !gt("10.3")) && nTalk.browser.firefox || nTalk.browser.mac) && hasFlash,
        ...
        return window.addEventListener ? (h = function (a, c, d, e) {
            ...
            var e = "{FNKEY::obj_" + a(b) + "::evt_" + c + "::fn_" + d + "}", f = j[e];
            "undefined" == typeof f && (f = function (a) {
                d.call(b, a)
            }, j[e] = f, b.attachEvent("on" + c, f), window.attachEvent("onunload", function () {
                try {
            ...
            var e = "{FNKEY::obj_" + a(b) + "::evt_" + c + "::fn_" + d + "}", f = j[e];
            "undefined" != typeof f && (b.detachEvent("on" + c, f), delete j[e]), e = null
        }), {__evtHash: j, addEvent: h, removeEvent: i, fixEvent: d, fireEvent: g}
    }(), nTalk.JSON = function () {
        function quote(a) {
            return reg.lastIndex = 0, reg.test(a) ? '"' + a.replace(reg, function (a) {
                    var b = meta[a];
        ...
        function str(a, b) {
            ...
            switch ("function" == typeof rep && (i = rep.call(b, a, i)), typeof i) {
                ...
                case"object":
                    ...
                    if (rep && "object" == typeof rep)for (f = rep.length, c = 0; c < f; c += 1)d = rep[c], "string" == typeof d && (e = str(d, i), e && g.push(quote(d) + (gap ? ": " : ":") + e)); else for (d in i)i.hasOwnProperty(d) && (e = str(d, i), e && g.push(quote(d) + (gap ? ": " : ":") + e));
                    return e = 0 === g.length ? "{}" : gap ? "{\n" + gap + g.join(",\n" + gap) + "\n" + h + "}" : "{" + g.join(",") + "}", gap = h, e
            }
        }
        ...
        add: function (a, b) {
            return typeof a !== core_strUndefined && (!this.contains(a) && (this.hashTable[a] = typeof b !== core_strUndefined ? b : null, this.hashIndex.push(a), !0))
        },
        remove: function (a) {
            var b = this.next(a), c = this.index(a);
            return delete this.hashTable[a], c !== !1 && this.hashIndex.splice(c, 1), this.hashTable[b]
        },
        first: function () {
        ...
        initialize: function (a, b, c, d) {
            var e = nTalk.merge({}, b), f = nTalk.randomChar(16);
            nTalk.isArray(c) ? (this.onComplete = c[0] || emptyFunc, this.onFailure = c[1] || emptyFunc) : (this.onComplete = c || emptyFunc, this.onFailure = emptyFunc), this.target = d || "POST_IFRAME_" + f, nTalk(".nTalk_post_hiddenElement").length > 0 ? this.hiddenElement = nTalk("#nTalk_post_hiddenElement") : this.hiddenElement = nTalk({
                tag: "div",
                id: "nTalk_post_hiddenElement",
                style: "left:-10px;top:-10px;visibility:hidden;display:none;width:1px;height:1px;"
            }).appendTo(!0), nTalk.inArray(this.target, this.CON_TARGET) < 0 && (this.iframeName = this.target, this.iframeElement = this.createIFrame(this.iframeName, "about:blank")), this.formName = "POST_FORM_" + f, this.formElement = this.form(a, e);
            try {
        ...
        createIFrame: function (a, b) {
            var c, d = this, e = function (b) {
                var c = this, g = c.readyState;
                /^(?:loaded|complete|undefined)$/.test(g) && !d._loaded && (nTalk(c).removeEvent("readystatechange", e), nTalk(c).removeEvent("load", e), nTalk(c).removeEvent("error", f), d._loaded = !0, d._stopCall || d.onComplete.call(d, b, a), window.frames[a] = window[a] = null, setTimeout(function () {
                    nTalk(c).remove(), nTalk(d.formElement).remove()
                }, 800))
            }, f = function (b) {
                var c = this;
                nTalk(c).removeEvent("readystatechange", e), nTalk(c).removeEvent("load", e), nTalk(c).removeEvent("error", f), d._stopCall || d.onFailure.call(d, b, a), window.frames[a] = window[a] = null, setTimeout(function () {
                    nTalk(c).remove(), nTalk(d.formElement).remove()
                }, 50)
            };
        ...
        form: function (a, b) {
            ...
            if (c = nTalk({
                    ...
                    target: this.target,
                    action: a
                }).appendTo(this.hiddenElement), nTalk.isArray(b))for (var d = 0; d < b.length; d++)for (var e in b[d])b[d].hasOwnProperty(e) && this.input(e + "[]", b[d][e], c); else for (var f in b)if (b.hasOwnProperty(f))if (nTalk.isArray(b[f]))for (var g = 0; g < b[f].length; g++)this.input(f + "[]", b[f][g], c); else this.input(f, b[f], c);
            return c.get(0)
        },
        ...
        inArray: function (a, b) {
            ...
            } else for (var d = 0, e = b.length; d < e; d++)if (b[d] == a)return d;
            return -1
        }, toURI: function (a, b, c) {
            var d = [], e = void 0 === c ? "&" : c, f = function (c, d) {
                var f = "&" == e ? c + "=" : "", h = typeof a[g];
                switch (h) {
                    case"object":
            ...
            for (var b, c = {}, d = a.toString().split("&"),
                     e = 0; e < d.length; e++)if (b = d[e].split("="), !(b.length < 2))try {
            ...
            if (b && nTalk.isArray(b))for (var f = 0,
                                               g = b.length; f < g; f++)c && c[f] && c[f] !== b[f] ? e[c[f]] = nTalk.isDefined(a[b[f]]) ? a[b[f]] : "" : e[b[f]] = nTalk.isDefined(a[b[f]]) ? a[b[f]] : ""; else e = a;
            ...
            return a.replace("-ms-", "ms-").replace(rCamelCase, function (a, b) {
                return (b + "").toUpperCase()
            })
        }, clearHtml: function (a) {
            return a = a || "", a.replace(clearHtmlExp, "")
            ...
            for (var b = [],
                     c = 0; c < a.length; c++)/[\u4e00-\u9fa5]/i.test(a.charAt(c)) ? b[c] = "\\u" + ("00" + a.charCodeAt(c).toString(16)).slice(-4) : b[c] = a.charAt(c);
            return b.join("")
        }, hexToDec: function (a) {
            if (!a)return "";
            var b = /\\u([0-9a-zA-Z]{2,4})|&#(\d+);/gi, c = a.match(b), d = a;
            if (!c)return d;
            for (var e = 0; e <= c.length; e++)if (c[e]) {
                var f, g, h = !1;
                f = c[e].replace("\\u", "");
                for (var i = 0; i < f.length; i++)"0123456789abcdef".indexOf(f.charAt(i)) == -1 && (h = !0);
        ...
        Element: function (a, b) {
            ...
            if (a = a.toLocaleUpperCase(), nTalk.inArray(a, ["IFRAME", "FORM", "INPUT", "SELECT", "TEXTAREA"]) > -1)try {
                "FORM" == a && (e = (b.method ? ' method="' + b.method + '"' : "") + (b.enctype ? ' enctype="' + b.enctype + '"' : "")), d = "<" + a + ' name="' + (b.name || nTalk.randomChar(16)) + '"' + e + "></" + a + ">", c = document.createElement(d), delete b.name
            } catch (f) {
                c = document.createElement(a)
            } else c = "comment" === a ? document.createComment(b.text || "") : document.createElement(a);
            return b && nTalk.each(b, function (a, b) {
                try {
                    switch (a) {
                        case"css":
                        case"style":
            ...
            switch (d = a.ownerDocument.createRange(), c) {
                case"beforebegin":
                    return d.setStartBefore(a), e = d.createContextualFragment(b), a.parentNode.insertBefore(e, a), a.previousSibling;
                case"afterbegin":
                    return a.firstChild ? (d.setStartBefore(a.firstChild), e = d.createContextualFragment(b), a.insertBefore(e, a.firstChild)) : a.innerHTML = b, a.firstChild;
                case"beforeend":
                    return a.lastChild ? (d.setStartAfter(a.lastChild), e = d.createContextualFragment(b), a.appendChild(e)) : a.innerHTML = b, a.lastChild;
                case"afterend":
                    return d.setStartAfter(a), e = d.createContextualFragment(b), a.parentNode.insertBefore(e, a.nextSibling), a.nextSibling
            }
            throw'Illegal insertion point -> "' + c + '"'
        }, flashHtml: function (a, b, c, d) {
            if (d = nTalk.extend({width: 1, height: 1, style: "", wmode: "opaque"}, d), nTalk.browser.oldmsie) {
                var e = b.indexOf("?") > -1 ? "&" : "?";
            ...
            if (a)return "undefined" != typeof c ? ("" === c ? a.removeAttribute(b) : a.setAttribute(b, c), c) : a.getAttribute ? a.getAttribute(b) : a[b] || ""
        }, addClass: function (a, b) {
            if (!a)return !1;
            if (this.indexOfClass(a, b))return !1;
            var c = a.className.split(/\s+/).join(" ");
            return a.className = (c ? c + " " : "") + b, !0
        }, removeClass: function (a, b) {
            return !(!a || !a.className) && (a.className = a.className.replace(new RegExp("(^|\\s+)" + b + "(\\s+|$)", "i"), " "), !0)
        }, indexOfClass: function (a, b) {
            return !(!a || !a.className) && new RegExp("(^|\\b)" + b + "(\\s|$)", "gi").test(a.className)
        }, contains: function (a, b) {
        ...
        defaultOptions: {
            ...
            var b, c, d = this;
            if (this.quirks) {
                b = nTalk(window).offset(), c = nTalk(window).scrollTop(), this.element.css({
                    position: "absolute",
        ...
        myString: function (a) {
            return str = new String(a || ""), str.trim = function () {
                return this.replace(/(^\s*)|(\s*$)/g, "")
            }, str.linkFilter = function (a) {
                return this.toString().replace(/((\w+):\/\/)?([\w-]+\.)([\w-]+\.)([a-zA-Z\-_\.]+)([^$\s,\"\u4E00-\u9FA5]*)?/gi, function (b, c, d, e, f, g, h) {
                    var i = (c || "http://") + (e || "") + f + g + (h || "");
                    return '<a href="' + i.replace(/(^\s+)|(\s+$)/gi, "") + '" target="_blank" style="' + (a || "") + '">' + (c || "") + (e || "") + f + g + (h || "") + "</a>"
                })
            }, str.linkFilter1 = function (a) {
                var b = this.toString();
                return b.indexOf("rightTag=true") > -1 ? b : this.toString().replace(/((\w+):\/\/)?([\w-]+\.)([\w-]+\.)([a-zA-Z\-_\.]+)([^$\s,\uFF0C\u3002\"\u4E00-\u9FA5]*)?/gi, function (b, c, d, e, f, g, h) {
                ...
                if (a < 1 || !RegExp)return b.toString();
                for (var c = 0; c < a; c++)b = b.replace(new RegExp("%" + (c + 1), "g"), (arguments[c] + "").replace(/%\d/g, "").toString());
                return b
            }, str
        },
        cssNumber: {
        ...
        valHooks: {
            option: {
                ...
                get: function (a) {
                    ...
                    if (f < 0)return null;
                    for (c = i ? f : 0, d = i ? f + 1 : h.length; c < d; c++)if (e = h[c], e.selected && null === e.getAttribute("disabled") && !e.parentNode.disabled && "OPTGROUP" !== e.parentNode.tagName.toUpperCase()) {
    ...
    }), nTalk.each(["radio", "checkbox"], function (a, b) {
        nTalk.valHooks[b] = {
            get: function (a) {
        ...
        nTalk.valHooks[b] = nTalk.extend(nTalk.valHooks[b], {
            set: function (a, b) {
                return a.checked = nTalk.inArray(nTalk(a).val(), b) >= 0, a.checked
            }
        })
    }), nTalk.fn.extend({
        bind: function (a, b) {
            return nTalk.access(this, function (a, b, c) {
            ...
            return nTalk.access(this, function (a, b, c) {
                return nTalk.Event.addEvent(a, "mouseover", b), nTalk.Event.addEvent(a, "mouseout", c), nTalk(a)
            }, a, b || emptyFunc)
            ...
            return void 0 !== a ? nTalk.each(this, function (b, c) {
                c.innerHTML = a
            }) : nTalk.isBoolean(b) && b ? (this.length ? this.get(0).innerHTML : "").replace(/(^\s+)|(\s+$)/gi, "") : this.length ? this.get(0).innerHTML : ""
        }, append: function (a) {
            return nTalk.each(this, function (b, c) {
                nTalk.insert(c, a, "beforeend")
            })
        }, appendTo: function (a, b) {
            var c, d = document.body || nTalk("body")[0] || document.documentElement;
            return "boolean" == typeof a && (b = a, a = null), c = a && "string" != typeof a ? a.talkVersion ? a.length ? a[0] : nTalk(d)[0] : a : nTalk(a || d)[0], nTalk.each(this, function (a, d) {
            ...
            return nTalk.each(this, function (b, c) {
                if (c.replaceNode) c.replaceNode(a); else try {
                    c.parentNode.appendChild(a), c.parentNode.removeChild(c)
                } catch (d) {
                }
            }), nTalk(a)
        }, find: function (a) {
            ...
            for (; a > 0 && b.parentNode && 11 !== b.parentNode.nodeType;)b = b.parentNode, a--;
            return b ? nTalk(b) : null
        }, child: function () {
            return this.find("*")
        }, remove: function () {
            return nTalk.each(this, function (a, b) {
                var c = !1;
                ...
                if (b.parentNode)try {
                    b.parentNode.removeChild(b), c = !0
                } catch (e) {
                }
                if (!c) {
                    var f = document.createElement("DIV");
                    try {
                        f.appendChild(b), f.innerHTML = "", f.parentNode && f.parentNode.removeChild(f)
                    } catch (g) {
                    }
                }
            })
            ...
            return nTalk.access(this, function (a, b, c) {
                c = c || "";
                var d = ";" + a.style.cssText, e = new RegExp(";\\s*" + b + ":\\s*(.*?);", "ig"),
                    f = ";" + b + ":" + c + ";", g = e.test(d);
                g ? a.style.cssText = d.replace(e, f) : a.style.cssText = d + f
            }, a, b, arguments.length > 1)
        }, Expression: function (a, b) {
            return nTalk.access(this, function (a, b, c) {
                if ("getExpression" in a.style)return void 0 === c ? a.style.getExpression(b) : "" === c ? a.style.removeExpression(b) : a.style.setExpression(b, c)
            }, a, b, arguments.length > 1)
        }, curClass: function () {
            ...
            return nTalk.each(this, function (c, d) {
                nTalk.addClass(d, a), nTalk.removeClass(d, b)
            })
        }, val: function (a) {
            if (!this.length)return "";
            var b, c, d, e = this[0];
            if (arguments.length)return nTalk.each(this, function (c, d) {
                null === a && (a = ""), b = nTalk.valHooks[d.type] || nTalk.valHooks[d.nodeName.toLowerCase()], b && "set" in b && void 0 !== b.set(this, a, "value") || (d.value = a)
            });
            ...
            if (b = nTalk.valHooks[e.type], b && "get" in b) {
                d = "radio" == this[0].type;
                for (var f = [],
                         g = 0; g < this.length; g++)if (void 0 !== (c = b.get(this[g], "value")) && this[g].checked) {
                    if (d)return c;
                    f.push(c)
                }
                return d ? "" : f
            }
            return c = this[0].value, "string" == typeof c ? c : null === c ? "" : c
        }, width: function (a) {
            var b;
            ...
            if (void 0 === a)try {
                ...
                return 0
            } else document.documentElement.scrollLeft = a, document.body.scrollLeft = a
            ...
            var b, c = this[0], d = {top: 0, left: 0}, e = c && c.ownerDocument;
        ...
        setOffset: function (a, b) {
            var c, d, e, f = nTalk.css(a, "position"), g = nTalk(a), h = {};
            "static" === f && (a.style.position = "relative"), d = g.offset(), c = nTalk.css(a, "top"), e = nTalk.css(a, "left"), null !== b.top && (h.top = b.top - d.top + (c || 0)), null !== b.left && (h.left = b.left - d.left + (e || 0)), g.css(h)
        }
    }, nTalk.cache = {
        data: null, init: function () {
            nTalk.cache.data = nTalk.extend({}, nTalk.cache.deserialize(nTalk.cookie.get(nTalk.CON_CACHE_COOKIE)))
        }, get: function (a, b) {
            return b === !0 && (nTalk.cache.data = nTalk.merge(nTalk.cache.data, nTalk.cache.deserialize(nTalk.cookie.get(nTalk.CON_CACHE_COOKIE)))), this.formatData(a)
        }, set: function (a, b) {
            return this.formatData(a, b), nTalk.cookie.set(nTalk.CON_CACHE_COOKIE, nTalk.cache.serialize(nTalk.cache.data), 0)
            ...
            return nTalk.isObject(a) ? (nTalk.each(a, function (a, d) {
                c.push(a + ":" + b.serialize(d))
            }), c.length ? "{" + c.join(",") + "}" : "{}") : a
        }, deserialize: function (a) {
            if (!a)return {};
            var b,
                c = /"/.test(a) ? a : a.replace(/(\{|\[)/g, '$1"').replace(/(}|])/g, '"$1').replace(/(:|,)/g, '"$1"');
            try {
            ...
            for (var c, d = a.split("."),
                     e = nTalk.cache.data; c = d.shift();)if (d.length > 0) e[c] || (e[c] = {}), e = e[c]; else {
                if (void 0 === b)return e[c] || null;
                if (!nTalk.isArray(b))return e[c] = b, nTalk.cache.data;
                var f = [];
                e[c] && (f = f.concat(e[c])), e[c] = f.concat(b)
            }
        }
        ...
        function a() {
            f = !0;
            var a = nTalk.getTime();
            a - h < 100 || (h = nTalk.getTime(), n && e(), nTalk.isFunction(nTalk.promptwindow.callbackFocus) && nTalk.promptwindow.callbackFocus())
        }

        function b() {
            f = !1, nTalk.isFunction(nTalk.promptwindow.callbackBlur) && nTalk.promptwindow.callbackBlur()
        }

        function c(a, b, c) {
            if (!g && !f) {
                if (b && b.length > 0) {
                    j = nTalk.myString(o).sprintf(b, "", l), k = "";
                    for (var e = 0, h = Math.ceil(nTalk.enLength(b) / 2); e < h; e++)k += "　";
                    k = nTalk.myString(o).sprintf(k, a, l)
                }
                return n = c || n, i = setInterval(d, 800), g = !0
            }
        }

        function d() {
            m++, document.title = m % 2 === 0 ? k : j;
            try {
        ...
        var f = !1, g = !1, h = nTalk.getTime(), i = null, j = null, k = null, l = document.title, m = 0, n = !0,
            o = "【%1】%2 - %3";
        return window.addEvent && (nTalk(document).bind("focusin", a), nTalk(document).bind("focusout", b)), nTalk(window).bind("focus", a), nTalk(window).bind("blur", b), {
    ...
    var createXHR = function () {
            ...
            var a = createXHR();
            return a ? "withCredentials" in a ? a : void 0 === window.XDomainRequest ? a : (a = new XDomainRequest, a.readyState = 0, a.status = 100, a.onreadystatechange = emptyFunc, a.onload = function () {
                a.readyState = 4, a.status = 200;
                var b = new ActiveXObject("Microsoft.XMLDOM");
                b.async = "false", b.loadXML(a.responseText), a.responseXML = b, a.response = a.responseText, a.onreadystatechange()
            }, a.ontimeout = a.oerror = function () {
                a.readyState = 4, a.status = 500, a.onreadystatechange()
            }, a) : a
        }, tepmxhr = xmlrequest(), hasSetRequestHeader = tepmxhr.setRequestHeader || !1,
        hasOverrideMimeType = tepmxhr.overrideMimeType || !1;
    tepmxhr = null, nTalk.doAjaxRequest = function (a) {
        var b = a.dataType || "text", c = a.success || emptyFunc, d = a.error || emptyFunc, e = xmlrequest();
        if (!e)return d("no xhr"), null;
        var f = function () {
            var a;
            if (4 === e.readyState) {
                var f = e.status || 0;
                if (200 === f) {
                    if ("json" === b) {
                        try {
                            a = nTalk.JSON.parse(e.responseText), c(a, e)
                        } catch (g) {
                            d(e.responseText, e, "response to json exception")
                        }
                        return
                    }
                    return void c(e.responseText, e)
                }
                if ("json" === b) {
                    try {
                        a = nTalk.JSON.parse(e.responseText), d(a, e)
                    } catch (g) {
                        d(e.responseText, e, "response to json exception")
                    }
                    return
                }
                c(e.responseText, e, "Server exception")
            }
            0 === e.readyState && c(e.responseText, e, "Server exception")
        };
        if (e.onreadystatechange = f, a.responseType) {
            if ("undefined" == typeof e.responseType)return d("", e, "Browser does not support setting response type"), null;
            e.responseType = a.responseType
        }
        if (a.mimeType) {
            if (!hasOverrideMimeType)return d("", e, "Browser does not support setting mimeType"), null;
            e.overrideMimeType(a.mimeType)
        }
        var g = a.headers || {};
        a.crossDomain || g["X-Requested-With"] || (g["X-Requested-With"] = "XMLHttpRequest");
        for (var h in g) {
            if (!hasSetRequestHeader)return d("", e, "Browser does not support setting header"), null;
            e.setRequestHeader(h, g[h])
        }
        var i = a.type || "GET";
        e.open(i, a.url);
        var j = a.data || null;
...
/* @file flashserver
 * @date 2016.12.21 01:27:06
 */
(function ($) {
    $.flashserver = {
        'trailserver': 'http://btrail.ntalker.com/trail/trail',
        'presenceserver': '0',
        ...
        'tchatmqttserver': 'tcp://bmqtt1.ntalker.com:9010/btchat11;ws://bmqtt1.ntalker.com:9011/btchat11;wss://bmqtt1.ntalker.com:9012/btchat11',
        'robotserver': 'http://robotassist.ntalker.com',
        'kpiserver': 'http://bkpi10.ntalker.com/',
        'isnoim': 2,
        'notrail': 0,
        'preload': 2000,
        'sessioncarry': '1',
        ...
        'entranceConfig': {},
        'tchatConnectType': '1',
        'settingserver': 'http://bsetting60.ntalker.com',
        'apiserver': 'http://api.ntalker.com/',
        'siteid': 'kf_9301'
    };
    $.sourceURI = $.baseURI + "siteid/respack_nt6.8.6/";
})(nTalk);
...
!function (a, b) {
    a.trail || (a.trail = {
        ...
        edata: "",
        start: function (b, c) {
            var d, e, f = this, g = a.referrer && a.referrer.indexOf(a.domain) > -1;
            this.called && !c || (a.Log("nTalk.trail.start()", 1), this.etype = c ? "update" : this.etype, b || "" === a.global.trailid || !g ? this.islogin = 1 : this.islogin = 0, d = this.formartData(), !a.isEmptyObject(a.global.ntalkerparam) && a.global.ntalkerparam && (e = a.extend({}, {ntalkerparam: a.global.ntalkerparam})), e = a.extend(e, {ref: document.referrer}), a.each(d, function (b, c) {
                f.request(f.formatURI() + a.toURI(c), e, function (b) {
                    a.Log(b, 1)
                }, b)
            }), this.called = !0)
        },
        request: function (b, c, d, e) {
            c ? (a.Log("nTalk.trail.request():etype:" + this.etype + ";POST request URI:" + b), new a.POST(b, c, function (a, b) {
                d.call(nTalk, "nTalk.trail: iframe[" + b + "] post complete.", 1)
            }, "POST_IFRAME_" + e)) : (a.Log("nTalk.trail.request():etype:" + this.etype + ";POST request URI:" + b), a.require(b + "#rnd", function () {
        ...
        formartData: function () {
            ...
            return a.global.pagetype && (a.url.indexOf("#") == -1 ? d.url += "#ntalker-pagetype=" + a.global.pagetype : a.url.indexOf("?") == -1 ? d.url = a.enCut(a.url.replace(/#/i, "?ntalker-pagetype=" + a.global.pagetype + "#"), 255) : d.url = a.enCut(a.url.replace(/#/i, "&ntalker-pagetype=" + a.global.pagetype + "#"), 255)), 1 == this.islogin && (a.cache.set("tid", a.global.trailid), d = a.merge(d, {
                lan: a.language,
                scr: screen.width + "*" + screen.height,
                cookie: a.cookie.enable() ? 1 : 0,
                flash: a.flash.version
            })), a.Log("nTalk.trail: " + (this.islogin ? "LOGIN" : "LINK") + " trailid:" + a.global.trailid + ", uid:" + a.user.id + ", pcid:" + a.global.pcid, this.islogin ? 1 : 0), a.global.orderid.length ? a.each(a.global.orderid, function (e, f) {
                b = e > a.global.orderprice.length - 1 ? "" : a.global.orderprice[e], c.push(a.merge({}, d, {
                    orderid: f,
                    orderprice: b,
...
!function (a, b) {
    ...
    return a.animate ? void a.Log("nt2.js loaded") : (a.animate = function () {
        ...
        return function (b, c, d, f) {
            var g = [], h = [], i = [], j = [], k = b.style;
            return d = d || 300, a.each(c, function (c, d) {
                h[c] = a.camelize(c), a.isObject(d) ? (d.to = d.to || 0, g[c] = a.cssNumber[c] ? d.to : parseInt(d.to, 10), i[c] = a.unit(c, d.to), a.isDefined(d.from) && a.css(b, h[c], parseInt(d.from, 10) + i[c])) : (g[c] = a.cssNumber[c] ? parseInt(d, 10) : d, i[c] = a.unit(c, d), a.css(b, h[c], g[c])), j.push(c)
            }), setTimeout(function () {
                k[e] = "all " + d + "ms", a.each(j, function (a, b) {
                    k[h[b]] = g[b] + i[b]
                })
        ...
        var f, g, h, i = 0, j = 0, k = 0, l = 30, m = [], n = [], o = [], p = [], q = [];
        for (d = d || 300, a.each(c, function (c, d) {
            o.push(a.camelize(c)), a.isObject(d) ? (g = d.to, a.isDefined(d.from) ? n.push(a.cssNumber[c] ? d.from : parseInt(d.from, 10)) : n.push(a.cssNumber[c] ? a(b).css(c) : parseInt(a(b).css(c), 10)), a.css(b, o[j], n[j] + a.unit(c, g))) : (g = d, n.push(a(b).css(c))), m.push(a.cssNumber[c] ? g : isNaN(parseInt(g, 10)) ? "" : parseInt(g, 10)), p.push(a.unit(c, g)), j++, k++
        }), f = 0; f < l; f++)for (q[f] = [], j = 0; j < k; j++)q[f][o[j]] = a.cssNumber[o[j]] || a.isNumeric(parseInt(n[j])) ? n[j] + (m[j] - n[j]) / l * f + ("opacity" === o[j] ? "" : p[j]) : "";
        for (var r = function () {
            for (j = 0; j < k; j++)a.css(b, o[j], q[i][o[j]]);
            i++
        }; j < l; j++)h = setTimeout(r, d / l * j);
        return setTimeout(function () {
            for (j = 0; j < k; j++)a.css(b, o[j], m[j] + p[j]);
            e && e.call(b)
        }, d), b
    }, a.extend({
        listenerFunctions: [], listenerMessage: function (b) {
            function c(b) {
                a.each(a.listenerFunctions, function (c, d) {
                    d.apply(a, [b.data])
                })
            }

            a.listenerFunctions.push(b), window.addEventListener && this.__listenerMessage !== !0 && (window.addEventListener("message", c), this.__listenerMessage = !0)
        ...
        initialize: function (b, c) {
            a.extend(this, this.defaultOptions, b), this.parent = c || null, this.quirks = a.browser.msie6 || a.browser.Quirks && a.browser.oldmsie, this.right = a(window).width() - this.left - this.width, this.bottom = a(window).height() - this.top - this.height, a.Log("$.Window:: left:" + this.left + ", top:" + this.top), this._create(), this._bind()
        },
        close: function (b) {
            this.cancelBubble(b), this.onClose.toString().indexOf("anonymous") <= -1 ? this.onClose() : this.containter.hide(function () {
                a(this).remove()
            })
        },
        change: function (a) {
        ...
        minimize: function (a, b) {
            b !== !0 && this.cancelBubble(a), this.containter.css({
                height: "0px",
                width: "0px"
            }), b !== !0 && this.onMinimize()
        },
        maximize: function (a, b) {
            this.containter.css({height: this.height + "px", width: this.width + "px"}), b !== !0 && this.onMaximize()
        },
        cancelBubble: function (b) {
            this.containter.css("z-index", this.zIndex), a.Event.fixEvent(b).stopPropagation()
        },
        changeAttr: function (b, c) {
            this.quirks && this.clearExpression(), a.extend(this, {
                width: b,
                height: c,
        ...
        fixedPosition: function () {
            if (this.quirks) {
                ...
                }), a(window).scrollTop(b), a(window).scrollLeft(1)
        ...
        _for_resize: function () {
            this.left = Math.max(0, a(window).width() - this.right - this.width), this.top = Math.max(0, a(window).height() - this.bottom - this.height), this.quirks || this.containter.css({
                left: this.left + "px",
                top: this.top + "px"
            })
        },
        _create: function () {
            return this.containter = a({
                ...
                height: this.height + "px",
                zIndex: this.zIndex
            }), this.fixedPosition(), this.header = a({
            ...
            }).appendTo(this.containter)), a({style: a.STYLE_BODY + "clear:both;"}).appendTo(this.containter), this.change(), this.containter
        },
        _bind: function () {
            var b = this;
            this.containter.bind("mousedown", function (a) {
                b.drag && b.start.call(b, a, !0)
            }), this.buttonClose.bind("mousedown", function (c) {
                a.Event.fixEvent(c).stopPropagation(), b.close.call(b, c)
            }), this.buttonMax.bind("mousedown", function (c) {
                a.Event.fixEvent(c).stopPropagation(), b.maxresize.call(b, c)
            }), this.buttonMin.bind("mousedown", function (c) {
                a.Event.fixEvent(c).stopPropagation(), b.minimize.call(b, c)
            }), this.chatBody.bind("mousedown", function (a) {
                b.cancelBubble.call(b, a)
            }), this.rightNode && this.rightElement.bind("mousedown", function (a) {
                b.cancelBubble.call(b, a)
            }), this.resize && this.buttonResize.bind("mousedown", function (a) {
                b.start.call(b, a, !1)
            }), this.fixed && a(window).bind("resize", function () {
                b._for_resize()
        ...
        list: null, length: 0, initialize: function () {
            ...
            return this.list.push(a), this.length = this.list.length, this.list[this.length - 1]
        }, deQueue: function () {
            var a;
        ...
        initialize: function (b, d) {
            var e, f, g = this, h = 3;
            this.debug && a.Log("pageManage.initialize():"), this.options = a.extend(this.options, {
                onChanage: c,
                onInterval: c,
                pageNum: 3,
                timeout: 2.5,
                inter: .8
            }, b), this.keyid = a.CON_MANAGE_COOKIE + (d ? "_" + d.toUpperCase() : ""), this.identid = this._2shortTime(0, 8, 13), a.browser.chrome && (this.options.timeout = 5), this.options.timeout *= 10, this.options.inter *= 1e3, this.inter = this.options.inter, this.pageStore = a.store;
            try {
                ...
                e.push(this.identid), this.pageStore.set(this.CON_MANAGE_PAGE_LIST, e.join(","))
            } catch (k) {
            }
            var l = a.getTime();
            this.interID = setInterval(function () {
                setTimeout(function () {
                    now = a.getTime();
                    var b = now - l;
                    g._update(b), g.options.onInterval(g.options.timeout, g.data.m), l = a.getTime()
                }, 0)
            }, this.options.inter), a.Event.addEvent(window, "unload", function () {
                g._remove(), setTimeout(function () {
                }, 500)
            })
        },
        ...
        _get: function () {
            ...
            return a.extend({m: []}, a.JSON.parseJSON(b))
        },
        _save: function () {
            var b = a.JSON.toJSONString(this.data);
            return a.cookie.set(this.keyid, b, 0), b
        },
        _remove: function () {
            var a = this._getIndex();
            this.data.m.splice(a, 1), this._save();
            ...
            if (b && "" !== b) {
                ...
                b = c.join(","), "" !== b ? this.pageStore.set(this.CON_MANAGE_PAGE_LIST, b) : this.pageStore.whereClear(this.CON_MANAGE_PAGE_LIST)
            }
        },
        _update: function (b) {
            this.data = this._get(), this._clear(b);
            var c = "update", d = this._getIndex();
        ...
        _clear: function (a) {
            ...
            if (this.data.m.length)for (var c,
                                            d = 0; d < this.data.m.length; d++)if (this.data.m[d])for (var e in this.data.m[d])if ("function" != typeof this.data.m[d][e] && (c = b - this.data.m[d][e], Math.abs(c) > this.options.timeout + a / 100)) {
                this.data.m.splice(d, 1), this.chanageCall = !0;
                ...
                f = g.join(","), "" !== f ? this.pageStore.set(this.CON_MANAGE_PAGE_LIST, f) : this.pageStore.whereClear(this.CON_MANAGE_PAGE_LIST)
            }
        },
        _getIndex: function () {
        ...
        _2shortTime: function (b, c, d) {
            ...
            return c = c || 5, d = d || 11, e.substring(c, d)
        }
    }, a.store = function () {
        var d, e = "__cometd__", f = {disabled: !1}, g = function () {
            var b = null;
            try {
                b = window.localStorage
            } catch (c) {
                return a.Log("localStorage:" + c.message, 3), !1
            }
            if (b) {
                var d = "test";
                try {
                    return null !== localStorage.getItem(d) && localStorage.removeItem(d), localStorage.setItem(d, d), localStorage.getItem(d) == d && (localStorage.removeItem(d), !0)
                } catch (c) {
                    return a.Log("The browser localStorage is unavailable. " + c.message, 3), !1
                }
            }
        }, h = a.browser.msie;
        if (f.toJSONString = function (b) {
            ...
            }, g()) d = window.localStorage, f.set = function (c, e) {
            ...
            var i, j, k = new RegExp("[!\"#$%&'()*+,/\\\\:;<=>?@[\\]^`{|}~]", "g"), l = function (a) {
                return function () {
                    ...
                    return b = a.apply(f, c), i.removeChild(d), b
                }
            }, m = function (a) {
                return a.replace(k, "___")
            };
            try {
                j = new ActiveXObject("htmlfile"), j.open(), j.write('<script type="text/javascript">document.w=window;</script><iframe src="/favicon.ico"></iframe>'), j.close(), i = j.w.frames[0].document, d = i.createElement("div")
            } catch (n) {
                d = document.createElement("div"), i = document.body || document.getElementsByTagName("head")[0] || document.documentElement
            }
            f.set = l(function (a, c, d) {
                ...
                return b = m(b), f.parseJSON(a.getAttribute(b))
            }), f.remove = l(function (a, b) {
                b = m(b), a.removeAttribute(b), a.save("nTK-LS")
        ...
        }, f.get = c, f.remove = c, f.clear = c, f.getAll = c;
        try {
            f.set(e, e), f.get(e) != e && (f.disabled = !0), f.remove(e)
        } catch (n) {
            f.disabled = !0
        }
        return f.whereClear = function (b) {
            var c = this, d = this.getAll();
            a.each(d, function (a) {
                a.indexOf(b) > -1 && c.remove(a)
            })
        }, f.enabled = !f.disabled, f
        ...
        _cacheElement: {},
        _connectTimeID: {},
        defaultOption: {muDomain: 3, timeout: 20, onCallback: c, onComplete: c, onAbnormal: c, onTimeout: c},
        initialize: function (b, c) {
            var d = this;
            this.uri = b, this.fix = a.randomChar(), this.uri || a.Log("comet uri is null", 3), this.callMethod = window, this.callbackName = "callback_" + this.fix, this.callMethod[this.callbackName] = function () {
                d._connectCallback.call(d, d.id, arguments)
            }, this.options = a.extend({}, this.defaultOption, c), this.initConnectionPooling()
        },
        initMessageQueue: function () {
            this.messageQueue || (this.messageQueue = new a.Queue, this.messageQueue.addMessage = function (a) {
                ...
                for (var c,
                         d = 0; d < this.length; d++)this.list[d].msgid != a || this.list[d].index != b && b != -1 || (c = d);
                this.list.splice(d, 1), this.length = this.list.length
            })
        },
        initConnectionPooling: function () {
            if (!this.connectionPooling) {
                this._ipExpr.test(this.uri) && (this.options.muDomain = 1), this.connectionPooling = new a.Queue, this.connectionPooling.get = function () {
                    for (var a, b, c,
                             d = 0; d < this.list.length; d++)this.list[d].lock === !1 && (!b || b.rTimesample > this.list[d].rTimesample) && (b = this.list[d]), (!c || this.list[d].sTimesample < c.sTimesample) && (c = this.list[d]);
                    return a = b || c, this.recover(a.uri, !0), a
                }, this.connectionPooling.getConnect = function () {
                    var a = this.get();
                    return {uri: a.uri, url: a.uri + (/\?$/gi.test(a.uri) ? "&" : "?")}
                }, this.connectionPooling.recover = function (b, c, d, e) {
                    for (var f = 0; f < this.list.length; f++)if (this.list[f].uri == b)return this.list[f].lock = c, c ? (this.list[f].sTimesample = d || a.getTime(), this.list[f].rTimesample = 0) : this.list[f].rTimesample = e || a.getTime(), !0;
                    return !1
                };
        ...
        connect: function (b, c) {
            ...
            this.connType = "login", this.id = this.fix + "_" + f, b[c || "callbackname"] = this.callbackName, this.connectOptions = a.extend(b, {ts: a.getTime()}), d = this.connectionPooling.getConnect(), e = d.url + a.toURI(this.connectOptions), this._cacheElement[this.id] = this._createConnect(e, this.id, f, d)
        },
        kalive: function (b, c) {
            var d, e, f = this.count++;
            this.connType = "kalive", this.id = this.fix + "_" + f, b[c || "callbackname"] = this.callbackName, this.kaliveOptions = a.extend(this.kaliveOptions, b, {ts: a.getTime()}), d = this.connectionPooling.getConnect(), e = d.url + a.toURI(this.kaliveOptions), this._cacheElement[this.id] = this._createConnect(e, this.id, f, d)
        },
        disconnectServer: function (b, c) {
            var d = this.connectionPooling.getConnect();
            return this.flashGoServer = d.url + a.toURI(c === !1 ? b : a.extend(b, {ts: a.getTime()})), this.flashGoServer
        },
        disconnect: function () {
            a.require(this.flashGoServer, function (b) {
        ...
        send: function (b, c) {
            var d = this, e = this.connectionPooling.getConnect(), f = this.mdyServerAddr(e.url) + a.toURI(b);
            return a.require(f + "#rnd", function (b) {
                d.connectionPooling.recover(e.uri, !1), c && c.call(d, b.error), a(b.error ? b.target : b).remove()
            }), !0
        },
        ...
        post: function (b, c) {
            var d = this, e = this.connectionPooling.getConnect();
            new a.POST(this.mdyServerAddr(e.url), b, function () {
                d.connectionPooling.recover(e.uri, !1), c && c.call(d, !0)
            })
        },
        _createConnect: function (b, c, d, e) {
            var f, g, h = this, i = document.head || nTalk("head")[0] || document.documentElement;
            return f = a({
                className: c,
                tag: "script",
                type: "text/javascript",
                ...
                src: b,
                charset: "utf-8"
            }).appendTo(i), g = f.get(0).readyState ? "onreadystatechange" : "onload", f.get(0)[g] = f.get(0).onerror = function (b) {
                var d = /^(loaded|complete|undefined)$/, g = f.get(0).readyState;
                b = a.Event.fixEvent(b), d.test(g) && (h.connectionPooling.recover(e.uri, !1), "error" !== b.type ? setTimeout(function () {
                    h._connectComplete(b, c), f.remove()
                }, a.browser.msie ? 800 : 50) : (h._connectAbnormal(b, c), f.remove()))
            }, this._connectTimeID[c] = setTimeout(function () {
                f.first().remove(), h._connectTimeout("timeout", c)
            }, 1e3 * +this.options.timeout + 1e4), f.get(0)
        },
        _connectCallback: function (b, c) {
            c = Array.prototype.slice.call(c), a("." + b).remove(), this._cacheElement[b] ? (this._stopCallComplete(b, "callback"), this.options.onCallback.apply(self, [!0, c])) : this.options.onCallback.apply(self, [!1, c])
        },
        ...
        _stopCallComplete: function (b) {
            ...
            d ? d.onload = d.onreadystatechange = d.onerror = c : a.Log("stop error id:" + b, 3), delete this._cacheElement[b], clearTimeout(this._connectTimeID[b]), delete this._connectTimeID[b]
        },
        ...
        initialize: function (b) {
            var c = this;
            this.options = a.extend({}, c._options, b), this.options.pcid = (this.options.siteid + "_" + this.options.pcid.substring(5)).substring(0, 23), a.require({mqtt: "mosquitto.js?siteid=" + a.extParmas.siteid}, function (b) {
                c.connect = new a.Mosquitto, c.connect.onmessage = function (b, d, e, f) {
        ...
        htmlToElement: function (b) {
            ...
            var b = a.toString().replace("#", ""), c = b.split(""), d = {};
            return d = 3 == b.length ? {
            ...
            return b = a.r / 255, c = a.g / 255, d = a.b / 255, h = Math.min(b, c, d), i = Math.max(b, c, d), j = i - h, k.l = (i + h) / 2, 0 === j ? (k.h = 0, k.s = 0) : (k.l < .5 ? k.s = j / (i + h) : k.s = j / (2 - i - h), e = ((i - b) / 6 + j / 2) / j, f = ((i - c) / 6 + j / 2) / j, g = ((i - d) / 6 + j / 2) / j, b == i ? k.h = g - f : c == i ? k.h = 1 / 3 - g + e : d == i && (k.h = 2 / 3 - e + f), k.h < 0 && (k.h += 1), k.h > 1 && (k.h -= 1)), k
        }
    }), a.fn.extend({
        animate: function (b, c, d) {
            ...
            return a.isFunction(b) && (c = b, b = 500), this.animate({
                visibility: "visible",
                opacity: {from: 0, to: 1}
            }, b || 500, c)
        }, hide: function (b, c) {
            return a.isFunction(b) && (c = b, b = 500), this.animate({opacity: {to: 0}}, b || 500, c)
        }, gradient: function (b, c, d) {
            var e, f;
            return b ? a.each(this, function (g, h) {
                ...
                } else if (a.browser.gecko) a(h).css("background-image", b ? "-moz-linear-gradient(" + b + ", " + c + ", " + d + ")" : "none"); else if (a.browser.oldmsie) {
            ...
            }) : a.each(this, function (b, c) {
                a.browser.oldmsie ? a(c).css("filter", "none") : a(c).css("background-image", "none")
            })
        }
    }), a.extend({
        base64: {
            _strKey: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", encode: function (b) {
                var c, d, e, f, g, h, i, j = a.base64, k = "", l = 0;
                for (b = j._utf8_encode(b || ""); l < b.length;)c = b.charCodeAt(l++), d = b.charCodeAt(l++), e = b.charCodeAt(l++), f = c >> 2, g = (3 & c) << 4 | d >> 4, h = (15 & d) << 2 | e >> 6, i = 63 & e, isNaN(d) ? h = i = 64 : isNaN(e) && (i = 64), k = k + j._strKey.charAt(f) + j._strKey.charAt(g) + j._strKey.charAt(h) + j._strKey.charAt(i);
                return k
            }, decode: function (b) {
                var c, d, e, f, g, h, i, j = a.base64, k = "", l = 0;
                for (b = (b || "").replace(/[^A-Za-z0-9\+\/=]/g, ""); l < b.length;)f = j._strKey.indexOf(b.charAt(l++)),
                    g = j._strKey.indexOf(b.charAt(l++)), h = j._strKey.indexOf(b.charAt(l++)), i = j._strKey.indexOf(b.charAt(l++)), c = f << 2 | g >> 4, d = (15 & g) << 4 | h >> 2, e = (3 & h) << 6 | i, k += String.fromCharCode(c), 64 != h && (k += String.fromCharCode(d)), 64 != i && (k += String.fromCharCode(e));
                ...
                for (var b, c, d, e = "",
                         f = 0; f < a.length;)b = a.charCodeAt(f), b < 128 ? (e += String.fromCharCode(b), f++) : b > 191 && b < 224 ? (c = a.charCodeAt(f + 1), e += String.fromCharCode((31 & b) << 6 | 63 & c), f += 2) : (c = a.charCodeAt(f + 1), d = a.charCodeAt(f + 2), e += String.fromCharCode((15 & b) << 12 | (63 & c) << 6 | 63 & d), f += 3);
                return e
            }
        }, FORM: {
            createInput: function (b, c, d) {
                for (var e, f, g, h, i = [], j = a.browser.mobile, k = a.extend({id: "", rowspan: 0, style: ""}, c),
                         l = '<span class="ntkf-text-red" style="' + a.STYLE_BODY + 'padding:2px 5px 2px 0;color:#f00;">' + (d || "") + "</span>",
                         m = 0; m < b.length; m++) {
                    switch (e = a.extend({
                        titlewidth: "80px",
                        inputwidth: "auto",
                        input: {width: "90%", height: "auto"}
                    }, b[m]), h = j ? e.title : e.title + (e.title.length == a.enLength(e.title) ? ":" : "："), /zh_cn|zh_tw/.test(a.lang.language) && a.enLength(e.title) > 16 || e.multipart || /radio|checkbox/.test(e.type) && e.options.length > 2 ? (e.multipart = !0, i.push(j ? '<tr style="' + a.STYLE_BODY + '"><td style="' + a.STYLE_BODY + 'width:100%;"><div class="nt-mobile-form-title" style="' + a.STYLE_BODY + 'width:100%; line-height:14px; font-size:14px; font-weight:bold; text-align:center; color:#333333; margin: 15px 0px 20px 0px">' + h + "</div>" : ['<tr style="', a.STYLE_BODY, '">', '<td style="', a.STYLE_BODY, 'vertical-align:top;line-height:28px;color:#333;" colspan="2">', '<div style="', a.STYLE_BODY, 'margin:5px 10px 5px 10px;color:#5a5a5a;">', h, e.required === !0 ? l : "", "</div>", "</td>", "</tr>", '<tr style="' + a.STYLE_BODY + '"><td style="', a.STYLE_BODY, 'padding:0 5px 0 0;text-align:right;vertical-align:top;line-height:28px;color:#333;"></td>', '<td style="' + a.STYLE_BODY + "line-height:28px;width:" + e.inputwidth + ';">'].join(""))) : i.push('<tr style="' + a.STYLE_BODY + '">' + (j ? "" : '<td style="' + a.STYLE_BODY + "padding:0 5px 0 0;text-align:right;vertical-align:top;line-height:28px;color:#333;width:" + e.titlewidth + ';"><div style="' + a.STYLE_BODY + 'margin:4px 0 0 0;text-align:right;color:#5a5a5a;">' + (e.required === !0 ? l : "") + h + "</div></td>") + '<td style="' + a.STYLE_BODY + "line-height:28px;width:" + (j ? "100%" : e.inputwidth) + ';">'), e.type) {
                        case"select":
                            i.push('<select data-index="' + m + '" name="' + e.name + '" style="' + a.STYLE_BODY + "border:1px solid #ccc;height:24px;color:#333;margin:0 0 4px;line-height:20px;width:" + (j ? "99%" : e.input.width) + ';">'), i.push('<option value="" style="' + a.STYLE_BODY + 'color:#ccc;">' + e.defaultText + "</option>");
                            for (var n = 0; n < e.options.length; n++)f = e.options[n], f = "string" == typeof f ? {
                                text: f,
                                value: f
                            } : f, i.push('<option value="' + f.value + '" style="' + a.STYLE_BODY + 'color:#333;">' + f.text + "</option>");
                            i.push("</select>");
                            break;
                        case"radio":
                            i.push('<ul style="' + a.STYLE_BODY + 'list-style:none;">');
                            for (var o, p = 0; p < e.options.length; p++)f = e.options[p], f = "string" == typeof f ? {
                                text: f,
                                value: f
                            } : f, o = e.name + "_" + p, g = e.defaultText == f.value ? " checked" : "", i.push('<li class="form-item" style="' + a.STYLE_BODY + 'list-style:none;padding:0 2px 0 0;color:#000;float:left;"><input type="radio" name="' + e.name + '"id="' + o + '" value="' + f.value + '" _custom_text="' + f.text + '" style="' + a.STYLE_BODY + 'color:#333;"' + g + ' /><label for="' + o + '" style="' + a.STYLE_BODY + 'display:inline;color:#000;">' + f.text + "</label></li>");
                            i.push('<li style="' + a.STYLE_BODY + 'list-style:none;clear:both;width:0;height:0;"></li>'), i.push("</ul>");
                            break;
                        case"checkbox":
                            i.push('<ul style="' + a.STYLE_BODY + 'list-style:none;">');
                            for (var q, r = 0; r < e.options.length; r++)f = e.options[r], f = "string" == typeof f ? {
                                text: f,
                                value: f
                            } : f, q = e.name + "_" + r, g = e.defaultText == f.value ? " checked" : "", i.push('<li class="form-item" style="' + a.STYLE_BODY + 'list-style:none;padding:0 2px 0 0;float:left;"><input type="checkbox" name="' + e.name + '" id="' + q + '" value="' + f.value + '" _custom_text="' + f.text + '" style="' + a.STYLE_BODY + 'color:#333;"' + g + ' /><label for="' + q + '" style="' + a.STYLE_BODY + 'display:inline;color:#000;">' + f.text + "</label></li>");
                            i.push('<li style="' + a.STYLE_BODY + 'list-style:none;clear:both;width:0;height:0;"></li>'), i.push("</ul>");
                            break;
                        case"textarea":
                            ...
                            break;
                        default:
                            i.push('<input data-index="' + m + '" type="text" name="' + e.name + '"' + (a.browser.html5 ? ' placeholder="' + e.defaultText + '" value=""' : ' value="' + e.defaultText + '"') + ' maxlength="32" style="' + a.STYLE_BODY + "border:1px solid #ccc;height:24px;width:" + (j ? "99%" : e.input.width) + ';margin:0 0 4px;color:#ccc;"'), "phone" == e.verification && i.push(" onblur=\"this.value=this.value.replace(/[^0-9-]+/, '');\" onkeyup=\"var keyCode=(event || window.event).keyCode; if( !/16|17|35|36|37|38|39|40/i.test(keyCode) ){this.value=this.value.replace(/[^0-9-]+/, '');}\""), i.push(" />")
                    }
                    e.messageid && (i.push('<div style="' + a.STYLE_BODY + 'display:none;color:#EF7208;" class="form-info ' + e.messageid + '">'), i.push('<div style="' + a.STYLE_BODY + "margin:2px;width:15px;height:15px;float:left;background:transparent url(" + a.sourceURI + '/images/chaticon.png) no-repeat -160px -39px;"></div>'), i.push('<div style="' + a.STYLE_BODY + 'color:#EF7208;float:left;" class="chat-view-info"></div>'), i.push('<div style="' + a.STYLE_BODY + 'clear:both;width:0;height:0;"></div>'), i.push("</div>")), i.push("</td>"), k.style && 0 === m && i.push('<td style="' + a.STYLE_BODY + k.style + '" id="' + k.id + '" rowspan="' + k.rowspan + '"></td></tr>')
                }
                return i.join("")
            }, bindFormEvent: function (b, c) {
                a(c).find("input[type=text], textarea").bind("focus", function () {
                    var c = a(this).css({color: "#333", "border-color": a.browser.mobile ? "#0079fe" : "#666"}),
                        d = c.attr("data-index") || 0, e = b[d].defaultText;
                    e == c.val() && c.val("")
                }).bind("blur", function () {
                    var c = a(this).css("border-color", "#ccc"), d = c.attr("data-index") || 0, e = b[d].defaultText;
                    "" === c.val() && c.val(e), "" !== c.val() && c.val() != e || c.css("color", "#ccc")
                })
            }, verificationForm: function (b, c, d, e) {
                for (var f, g, h, i, j, k = [], l = !1, m = new RegExp("\\d{6,}", "i"),
                         n = new RegExp("^[a-zA-Z0-9\\._-]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$", "i"), o = this,
                         p = function (b, c) {
                             c.checked && (j = {value: a(c).val() || "", text: a(c).attr("_custom_text")})
                         }, q = function () {
                        a(this).display()
                    }, r = 0; r < b.length; r++) {
                    switch (b[r].type) {
                        case"checkbox":
                            j = [], f = a(d).find("input[name=" + b[r].name + "]"), g = a(d).find("input[name=" + b[r].name + "][checked]");
                        ...
                        case"radio":
                            j = {
                                value: "",
                                text: ""
                            }, f = a(d).find("input[name=" + b[r].name + "]"), a(d).find("input[name=" + b[r].name + "][checked]").each(p);
                            break;
                        case"select":
                            f = a(d).find("select[name=" + b[r].name + "]"), j = a("option[selected]", f).val() || "", j = b[r].defaultText && j == b[r].defaultText ? "" : j;
                            break;
                        case"textarea":
                            f = a(d).find("textarea[name=" + b[r].name + "]"), b[r].defaultText && b[r].defaultText == f.val() ? (j = "", f.val("")) : j = f.val().replace(/(^\s*)|(\s*$)/g, "");
                            break;
                        default:
                            f = a(d).find("input[name=" + b[r].name + "]"), b[r].defaultText && b[r].defaultText == f.val() ? (j = "", f.val("")) : j = f.val().replace(/(^\s*)|(\s*$)/g, "")
                    }
                    h = "string" == typeof j ? "" === j || !j.length : a.isArray(j) ? 0 === j.length : "" === j.value, i = !(!b[r].messageid || !b[r].message);
                    var t = a(d).find("." + b[r].messageid), u = a(d).find("." + b[r].messageid + " .chat-view-info");
                ...
                if (b && c)if (a.browser.mobile) {
                    ...
                    this.messageErrorToast = new a.Toast('<div id="#message_error" style="position: relative;width: ' + (i - 50) + 'px; height:30px; line-height: 30px;z-index:100; color: #FFF; top: 30px; left: 25px; text-align:center;font-weight:bold">' + c + "</div>", {
                        ...
                        h.messageErrorToast.remove(), h.messageErrorToast = null, f.get(0).focus()
                    }, 2e3)
                } else d.html(c), e.display(1).show(), f.get(0).focus(); else/radio|checkbox/.test(g) ? f.parent().css("color", "#f00") : f.css("border-color", "#f00").get(0).focus()
            }
        }
        ...
        initialize: function (b, d) {
            ...
            var f = this, g = Math.max(20, this.button.width(), parseFloat(this.button.css("width"))),
            ...
            this.completed = function (a) {
                var b = /^(?:loaded|complete|undefined)$/, c = this.readyState;
                ...
                style: i
            }).appendTo(this.button, !0), this.iframe = a({
                tag: "IFRAME",
                name: this.options.target,
                src: "about:blank",
                style: i + "width:0;height:0;display:none;"
            }).appendTo(this.button, !0), this.element = a({
                tag: "INPUT",
                type: "file",
                ...
                "" !== this.value && f.form.get(0).reset(), f.iframe.bind("readystatechange", f.completed).bind("load", f.completed), f.fkey = a.randomChar(16)
            }).bind("change", function (a) {
                var b = {};
                this.files ? (b.name = this.files[0].name, b.size = this.files[0].size) : (b.name = this.value.substring(this.value.lastIndexOf("\\") + 1), b.size = ""), b.name && (f.options.onChange(b), f.fileChange(a, this.files || this.value))
            })
        },
        transferComplete: function (b, c) {
            ...
            c && (this.debug && a.Log("$.upload.transferComplete(event, " + c + ")"), a.jsonp(this.options.server + "?" + a.toURI(a.extend({
                    getaction: 1,
                    fkey: c
                }, this.options.params)) + "#rnd", function (b) {
                d.debug && a.Log("get transfer file info:" + a.JSON.toJSONString(b), 1), b.name = d.options.curName || d.options.name || "", d.options.callback(b)
            }))
        },
        fileChange: function (b, c) {
            var d = this;
            this.isMobileCompTransf(c, function (e) {
                e ? a.browser.oldAndroid ? a.require("jpeg_encoder_basic.js?siteid=" + d.options.params.siteid, function (a) {
                    d.mobileCompTransf(b, c)
                }) : a.browser.oldIOS ? a.require("megapix-image.js?siteid=" + d.options.params.siteid, function (a) {
                    d.mobileCompTransf(b, c)
                }) : d.mobileCompTransf(b, c) : d.commonTransf(b, c)
            })
        },
        isMobileCompTransf: function (b, c) {
            if (a.browser.mobile && (window.URL || window.webkitURL) && document.createElement("canvas"))if (b[0].name.toLowerCase().indexOf("jpg") > -1) c(!0); else if (window.FileReader && window.DataView) {
        ...
        commonTransf: function (b, c) {
            ...
            try {
                d = f ? this.proxy.fileOptions.fileMaxSize : this.proxy.fileOptions.imageMaxSize, e = f ? this.proxy.fileOptions.fileExt : this.proxy.fileOptions.imageExt
            } catch (g) {
                d = null, e = null
            }
            if ("string" == typeof c) this.debug && a.Log("Name: " + c, 2); else for (var h, i = 0; i < c.length; i++) {
                var j, k = c[i];
                ...
                if ("*" != this.options.accept && this.options.accept || e) {
                    if (this.options.accept && this.options.accept.indexOf("/*") > -1) {
                        if (h = new RegExp(this.options.accept.replace(/\//, "\\/"), "gi"), !h.test(k.type))return a.Log("accept:" + this.options.accept + ", type:" + k.type, 2), void this.options.onError({
                            type: 9,
                            name: k.name,
                            size: k.size,
                            etype: "TYPE"
                        ...
                        if (this.options.accept && this.options.accept.indexOf(k.type) <= -1)return a.Log("accept:" + this.options.accept + ", type:" + k.type, 2), void this.options.onError({
                            type: 9,
                            name: k.name,
                            size: k.size,
                            etype: "TYPE"
                        ...
                        if (e && e.indexOf(j) == -1)return void this.options.onError({
                            type: 9,
                            name: k.name,
                            size: k.size,
                            ext: e,
                    ...
                    this.options.curName = k.name, this.debug && a.Log("Name: " + this.options.curName)
                }
            }
            this.debug && a.Log("$.upload.fileChange()"), this.form.attr("action", this.options.server + "?" + a.toURI(a.extend({
                    fkey: this.fkey,
                    rnd: a.getTime()
                }, this.options.params))), a.browser.mobile && this.options.callback({
                status: "startUpload",
                oldfile: c[0].name
        ...
        mobileCompTransf: function (b, c) {
            var d = this;
            this.options.callback({status: "startCompress", oldfile: c[0].name});
            new a.ImageOrientation(c[0], function (b, e) {
                new a.CompressImg(c[0], {orientation: e}, function (b, e) {
                    d.formData = new FormData, d.formData.append("base64", e), d.formData.append("fname", a.getTime() + ".jpg"), d.options.action = "uploadimage", d.options.siteid = d.options.params.siteid, a.each(d.options, function (a, b) {
                    ...
                    }, d.options.callback({status: "startUpload", oldfile: c[0].name, compress: !0});
                    try {
        ...
        base64Transf: function (b) {
            var c = this;
            this.fkey = a.getTime(), new a.POST(this.options.server + "?action=uploadimage", a.extend({
                base64: b,
                fname: a.getTime() + ".png",
                fkey: this.fkey,
                rnd: a.getTime()
            }, this.options.params), function (a) {
        ...
        initialize: function (b, c, d) {
            var e = this;
            this.url = window.URL || window.webkitURL, this.canvas = document.createElement("canvas"), this.blob = "string" == typeof b ? b : this.url.createObjectURL(b), this.options = a.extend(c, this.options), this.image = new Image, this.image.onerror = function () {
                a.Log("加载图片失败！")
            }, this.image.onload = function (b) {
                e.getCompImage(), d(b, e.dataurl);
                var c = a.browser.oldIOS ? 1e4 : 0;
                setTimeout(function () {
                    for (var a in e)e.hasOwnProperty(a) && (e[a] = null)
                }, c)
            }, this.image.crossOrigin = "*", this.image.src = e.blob
        },
        drawOldIOSCanvas: function () {
            var a = new MegaPixImage(this.image);
            "5678".indexOf(this.options.orientation) > -1 ? a.render(this.canvas, {
                width: this.canvas.height,
                height: this.canvas.width,
                orientation: this.options.orientation
            }) : a.render(this.canvas, {
        ...
        getCompImage: function () {
            var b = this;
            if (this.ctx = this.canvas.getContext("2d"), this.resize = this._getResize(), this.canvas.width = this.resize.width, this.canvas.height = this.resize.height, this.ctx.fillStyle = "#fff", this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height), a.browser.oldIOS ? this.drawOldIOSCanvas() : this.drawCanvas(), a.browser.oldAndroid) {
                var c = new JPEGEncoder, d = this.ctx.getImageData(0, 0, this.canvas.width, this.canvas.height);
        ...
        _getResize: function () {
            var a = this, b = this.image, c = this.options.width, d = this.options.height,
            ...
            for (c && d ? f >= c / d ? e.width > c && (e.width = c, e.height = Math.ceil(c / f)) : e.height > d && (e.height = d, e.width = Math.ceil(d * f)) : c ? c < e.width && (e.width = c, e.height = Math.ceil(c / f)) : d && d < e.height && (e.width = Math.ceil(d * f), e.height = d); e.width >= 3264 || e.height >= 2448;)e.width *= .8, e.height *= .8;
            return e
        }
    }, a.ImageOrientation = a.Class.create(), a.ImageOrientation.prototype = {
        initialize: function (b, c) {
            if (!window.FileReader || !window.DataView)return 1;
            var d = this, e = new FileReader;
            e.onload = function (b) {
            ...
            var f, g, h, i = a.getUint16(b + 2, !e), j = a.getUint32(b + 4, !e), k = a.getUint32(b + 8, !e) + c;
            switch (i) {
                case 3:
                    if (1 == j)return a.getUint16(b + 8, !e);
                    for (f = j > 2 ? k : b + 8, g = [], h = 0; h < j; h++)g[h] = a.getUint16(f + 2 * h, !e);
                    return g
            }
        ...
        initialize: function (b, c) {
            var d = this;
            this.options = a.extend({}, this.def, c), this.id = a.randomChar(), this.selector = ".dialog-container-" + this.id, this._create(), this._style(this.options.style), this.display = !0, this.options.close && (b += '<div class="dialog-button-close" style="' + a.STYLE_NBODY + 'font-size:14px;position:absolute;right:10px;top:10px;width:20px;height:20px;line-height:20px;text-align:center;cursor:pointer;">x</div>'), this.container.html(b), setTimeout(function () {
                d.container.css({top: Math.max(0, (a(d.options.parent).height() - Math.max(d.container.height(), 200)) / 2) + "px"})
            }, 5), this._funcResize = function () {
                d.resize()
            }, this.options.parent == window && a(window).addEvent("resize", this._funcResize), this.container.find(".dialog-button-close").click(function () {
                d.close()
            })
        },
        close: function () {
            var b = this;
            this.options.parent == window && a(window).removeEvent("resize", this._funcResize), a(this.selector).hide(function () {
                a(".dialog-iframe-" + b.id + ",.dialog-background-" + b.id).remove(), a(b.selector).remove(), b.display = !1
            })
        },
        resize: function (b, c) {
            b = b || a(this.options.parent).width(), c = c || a(this.options.parent).height(), a(".dialog-iframe-" + this.id + ",.dialog-background-" + this.id).css({
                width: b + "px",
                height: c + "px"
            });
            ...
            this.container.css({
                ...
                "max-width": b + "px",
                "max-height": c - 40 + "px"
            }), this.container.css("top", Math.max(0, (c - Math.max("auto" == d ? this.container.height() : d, 200)) / 2) + "px"), this.options.resizeFunc && this.options.resizeFunc.call()
        },
        _create: function () {
            ...
            this.container = a({
                ...
                style: a.STYLE_BODY + "position:" + c + ";left:0;top:0;margin:0;min-height:" + (this.options.minHeight ? this.options.minHeight : 200) + "px;border-radius:0px;z-index:" + d + ";background:#fff;overflow-x:hidden;overflow-y:hidden;"
            }).appendTo(b), this.background.bind("touchstart", function (b) {
                var c = a.Event.fixEvent(b);
        ...
        _style: function (b) {
            var c = a(this.options.parent).width(), d = a(this.options.parent).height();
            ...
            1 == e.length && e.push(this.options.margin), this.container.css(b).css({
                left: e[0] + "px",
                top: e[1] + "px",
        ...
        initialize: function (b, c) {
            var d = this;
            this.id = a.randomChar(), this.options = a.extend(this.options, c), this.toastOpacity = a({
                tag: "div",
            ...
            }), this.toast.html(b), this._create(), this._funcResize = function () {
                d.resize()
        ...
        remove: function () {
            a(".toast-opacity-" + this.id).remove(), a(".toast-" + this.id).remove()
        }
        ...
        initialize: function (b) {
            var c = this;
            this.options = a.extend(this.options, b), this.inter = setInterval(function () {
                c.options.inTimeFunc.call(c)
            }, this.options.doTime), this.timeout = setTimeout(function () {
                clearInterval(c.inter), c.options.outTimeFunc.call(c)
            }, this.options.allTime)
        },
        remove: function () {
            a.Log("giftimer remove"), clearInterval(this.inter), clearTimeout(this.timeout), this.inter = null, this.timeout = null
        }
        ...
        initialize: function (a, b, c, d, e, f, g) {
            this.msgid = a, this.url = b, this.type = c, this.duration = d, this.viewCallback = e, this.eventCallback = f, this.container = g, this.audioFlag = this.canPlayAudioMP3(), this.audioFlag ? this.createAudioPlayer() : this.createSwfPlayer(), this.viewCallback.call(this, "init"), this.eventCallback.call(this, "init")
        },
        createAudioPlayer: function () {
            ...
            }, a.Event.addEvent(this.musicEl, "ended", function () {
                a.Log(b.debugStr + " trigger ended stop mp3"), b.viewCallback.call(b, "stop")
            }), this.musicEl.getPaused = function () {
                return this.paused
            }
        },
        createSwfPlayer: function () {
            var b = this, c = "ntalker_swf_mp3Player_container_" + this.msgid,
                d = "ntalker_swf_mp3player_" + this.msgid, e = a.sourceURI + "fs/music.swf",
                f = a.flashHtml(d, e, "id=" + d);
            this.musicEl = document.createElement("div"), this.musicEl.innerHTML += f, this.musicEl.id = c, this.container.append(this.musicEl.outerHTML);
            var g = a.browser.msie && a.browser.ieversion <= 7 ? window[d] : document[d];
            setTimeout(function () {
                g.emit("load", b.url), g.emit("stop"), b.musicEl.play = function () {
                    g.emit("play")
        ...
        play: function () {
            a.Log(this.debugStr + "play mp3"), this.musicEl.play(), this.viewCallback.call(this, "play")
        },
        stop: function () {
            a.Log(this.debugStr + "stop mp3"), this.musicEl.stop(), this.viewCallback.call(this, "stop")
        },
        ...
        initialize: function (a, b) {
            this.data = a.clipboardData || window.clipboardData, this.callback = b
        },
        getImgBase64Str: function () {
            var b = this, c = this.data;
            if (!c)return null;
            if ("function" == typeof webInfoChanged) this.callback(c.getData("image/x-vnd.adobe.air.bitmap").toDataURL()); else if (a.browser.chrome || a.browser.opera) {
                var d, e, f = c.items;
                if (f) {
                    d = f[0], e = c.types || [];
                    for (var g = 0, h = e.length; g < h; g++)if ("Files" === e[g]) {
                        d = f[g];
                        break
                    }
                    if (d && "file" === d.kind && d.type.match(/^image\//i)) {
                        var i = d.getAsFile(), j = new FileReader;
                        j.onload = function (a) {
 ...
 */
!function (a, b) {
    var c = ["kf_9933", "kf_9949", "kf_9954"], d = "nt-flash-div", e = "ntkf_flash_ntid", f = 2, g = {
        trailserver: "",
        presenceserver: "",
        presencegoserver: "",
        crmcenter: "",
    ...
    if (a.baseURI && !a.base) {
        if (a.extend({
                ...
                chanageUserID: function () {
                    return "undefined" != typeof NTKF_PARAM && (!(!NTKF_PARAM.uid || !this.toLongID(NTKF_PARAM.uid) || this.toLongID(NTKF_PARAM.uid) == a.user.id) && !(a.inArray(a.global.siteid, c) > -1 && a.global.siteid + "_ISME9754_" + NTKF_PARAM.uname == a.user.id))
                },
                overloadedData: function (b, c) {
                    a.isFunction(b) && (c = b, b = null), a.Log("nTalk.base.overloadedData()"), a.isEmptyObject(CON_RULE) ? (this.getPageData(b), a.user.id = a.global.uid || a.user.id, a.user.name = a.global.uname || "", a.cache.set("uid", a.user.id), a.isFunction(c) && c(), a.base.startTrail(a.base._islogin, !0)) : this.startData(function () {
                        a.user.id = a.global.uid || a.user.id, a.user.name = a.global.uname || "", a.cache.set("uid", a.user.id), a.isFunction(c) && c(), a.base.startTrail(a.base._islogin, !0)
                    }, b)
                },
                startData: function (b, c) {
                    var d = this;
                    a.Log("nTalk.base.startData()"), a.require({data: "data.js" + a.baseExt}, function (e) {
                        if (!e)return void a.Log("Loaded $data mode failed", 3);
                        var f = a.data.start(CON_RULE);
                        d._get_page_data = a.extend({}, f, c), d.getPageData(d._get_page_data), b.call(d)
                    })
                },
                _execMode: function () {
                ...
                startTrail: function (b, c) {
                    a.require({trail: "trail.js" + a.baseExt}, function (d) {
                        return d ? void a.trail.start(b, c) : void a.Log("Loaded $trail mode failed", 3)
                    })
                },
                startIM: function () {
                    a.im && a.im.connect || a.require({im: "im.js" + a.baseExt}, function (b) {
                        return b ? void a.im.start() : void a.Log("Loaded $im mode failed", 3)
                    })
                },
                startLCrm: function (b, c, d) {
                    var e = b && a.isArray(b) ? b : [b];
                    a.require({lcrm: "lcrm.js" + a.baseExt}, function (b) {
                        a.each(e, function (b, e) {
                            a.Log("start lcrm mode", 1), a.lcrm.start(e, c, d)
                        })
                    })
                },
                startChat: function (b, c, d, e, f, g, h, i) {
                    var j;
                    return b = b || "", c = c || "", d = d || "", e = e || "", f = f || "", a.im && a.im.hideTips(), a.base.chatLoading === !0 ? void a.Log("loading......", 2) : (a.Log("$.base.startChat(" + a.JSON.toJSONString(arguments) + ")", 1), a.base.showLoading(), j = {lang: (a.extParmas.lan || "zh_cn") + ".js" + a.baseExt}, a.browser.supportMqtt && a.server.tchatmqttserver && 1 == a.server.tchatConnectType ? (j.MQTT = "mqtt31.js" + a.baseExt, j.Connection = "mqtt.chat.js" + a.baseExt) : a.flash.support && a.server.tchatmqttserver && 1 == a.server.tchatConnectType ? (j.MQTT = "flashsock.js" + a.baseExt, j.Connection = "mqtt.chat.js" + a.baseExt) : j.TChat = "comet.chat.js" + a.baseExt, a.global.themes ? (j.chatManage = "chat.js" + a.baseExt, j.chatManageView = a.global.themes + "/chat.view.in.js" + a.baseExt, a.themesURI = a.global.themes + "/images/") : j.chatManage = "chat.in.js" + a.baseExt, j.Window = "nt2.js" + a.baseExt, 1 == a.server.robot && (j.Robot = "robot.js" + a.baseExt), void a.require(j, function () {
                        return a.base.hiddenLoading(), a.chatManage ? (a.Log("load $chatManage mode complete"), void(a.chatManage.open(b, c, d, e, f, g, h, i) && a.cache.set("opd", 1))) : void a.Log("Load $chatManage mode failed", 3)
                    }))
                },
                startEntrance: function () {
                    var b = a.server.entranceConfig[a.global.settingid] || "";
                    a.Log("$.base.startEntrance()"), b && a.server.entranceConfig && !a.isEmptyObject(a.server.entranceConfig) && a.require({entrance: b + a.baseExt}, function (b) {
                        return b ? ("0" != a.server.enable_entrance && a.options.entrance && a.entrance.start("entrance"), void("0" != a.server.enable_entrance && a.options.invite && a.entrance.start("invite"))) : void a.Log("Load $.entrance mode failed", 3)
                    })
                },
                showLoading: function () {
                    return a.base.chatLoading = !0, a.base.startTime = a.getTime(), this.loadingElement && this.loadingElement.length ? this.loadingElement.display(1) : this.loadingElement = a({
                        id: "ntalk-chat-loading",
                        style: a.STYLE_NBODY + "width:100%;height:33px;position:fixed:right:0;bottom:0;z-index:9999;"
                    }).appendTo(!0).fixed({
                        right: 0,
                        bottom: 0
                    }).html('<div style="' + a.STYLE_BODY + "margin:0 auto;width:99px;height:33px;background:url(" + a.imageloading + ') no-repeat 0 0;"></div>'), this.loadingElement
                },
                hiddenLoading: function () {
                    this.loadingElement.display(), a.base.endTime = a.getTime(), a.base.chatLoading = !1, a.Log("$.base.showLoading-hiddenLoading execute time:" + (a.base.endTime - a.base.startTime) + " ms", 1)
                },
                toLongID: function (b) {
                ...
                checkID: function (b) {
                    return b = b ? b.toString() : "", !(!b || "0" === b) && (b.indexOf("_ISME9754_T2D") > -1 ? a.CON_CUSTOMER_ID : b.indexOf("_ISME9754_GT2D") > -1 ? a.CON_GROUP_ID : b.indexOf(a.global.siteid + "_ISME9754_") > -1 ? a.CON_VISITOR_ID : a.CON_SHORT_ID)
                },
                startOtherMode: function (b, c) {
                    var d, e, f = a.cache.get("uid") || "";
                    if (clearTimeout(this._connectTimeID), this._connectTimeID = null, this._identityIDReady = !0, a.Log("cache uid:" + f + ", site uid:" + b + ", return uid:" + b, 1), f ? this._islogin = f != b : this._islogin = !0, a.global.pcid = c, a.user.id = b, a.isDefined(a.global.uname) && (a.user.name = a.global.uname), a.cache.set("uid", b), a.cookie.set(a.CON_PCID_KEY, c, 63072e6), 0 === a.server.notrail ? this.startTrail(this._islogin, !1) : a.Log("no load trail"), a.server.entranceConfig && ("0" != a.server.enable_entrance || "1" == a.server.enable_invite)) {
                        if ("2" == a.server.enable_entrance && a.browser.mobile)return;
                        this.startEntrance()
                    }
                    if (!a.server.isnoim || 3 == a.server.isnoim || 2 == a.server.isnoim && "1" == a.cache.get("opd") ? (a.Log("nTalk.base.startIM()::" + a.im, 1), this.startIM()) : a.Log("no load im, isnoim:" + a.server.isnoim + ", opd:" + a.cache.get("opd"), 1), 1 == a.browser.mobile) {
                        var g = [".full-html,.full-body{", "width: 100% !important;", "height: 100% !important;", "margin: 0 !important;", "overflow: hidden !important;", "}", ".full-body *{", "display: none !important;", "}", ".full-iframe {", "display: block !important;", "}"].join("");
                        a.addMobileStyle(g)
                    }
                    e = {
                        settingid: a.cache.get("carry_sid"),
                        destid: a.cache.get("carry_did")
                    }, "0" != a.server.sessioncarry && e.settingid && !a.browser.mobile ? (a.Log("sessioncarry:" + a.JSON.toJSONString(e)), a.cache.set("carry_sid", ""), a.cache.set("carry_did", ""), e.settingid && (a.browser.mobile || !a.global.pageinchat ? (d = {single: -1}, a.im_openOutPageChat(e.settingid, "", e.destid, d, "")) : (d = {
                        autoconnect: !0,
                        single: -1
                ...
                preloadChat: function () {
                    var b;
                    a.Log("$.base.preloadChat()", 1), setTimeout(function () {
                        a.base.chatLoading !== !0 && (b = {lang: (a.extParmas.lan || "zh_cn") + ".js" + a.baseExt}, a.global.themes ? (b.chatManage = "chat.js" + a.baseExt, b.chatManageView = a.global.themes + "/chat.view.in.js" + a.baseExt, a.themesURI = a.global.themes + "/images/") : b.chatManage = "chat.in.js" + a.baseExt, b.Window = "nt2.js" + a.baseExt, a.browser.supportMqtt && a.server.tchatmqttserver && 1 == a.server.tchatConnectType ? (b.MQTT = "mqtt31.js" + a.baseExt, b.Connection = "mqtt.chat.js" + a.baseExt) : a.flash.support && 1 == a.server.tchatConnectType ? (b.MQTT = "flashsock.js" + a.baseExt, b.Connection = "mqtt.chat.js" + a.baseExt) : b.TChat = "comet.chat.js" + a.baseExt, 1 == a.server.robot && (b.Robot = "robot.js" + a.baseExt), a.require(b, function (b, c) {
                ...
                getPageData: function (b) {
                    var d;
                    return a.Log("nTalk.base.getPageData()"), d = a.extend({}, "undefined" != typeof NTKF_PARAM ? NTKF_PARAM : {}, b), a.whereGetTo(a.global, d, ["siteid", "sellerid", "settingid", "uid", "uname", "exparams", "themes", "isvip", "userlevel", "itemid", "itemparam", "orderid", "orderprice", "erpparam", "ntalkerparam", "pagetype", "title", "lang", "iconid"], [null, null, null, "shortid", "uname", "exparams", "themes"]), a.global.siteid = (a.global.siteid + "").replace(/^\s+|\s+$/, ""), a.global.settingid = (a.global.settingid + "").replace(/^\s+|\s+$/, ""), a.global.siteid = a.global.siteid && i.test(a.global.siteid) ? a.global.siteid : a.extParmas.siteid || "", "" !== a.global.siteid && (a.global.pagetype = a.params.source || "", a.global.sellerid = a.isArray(a.global.sellerid) ? a.global.sellerid : a.global.sellerid.toString().indexOf(",") > -1 ? a.global.sellerid.split(",") : a.global.sellerid ? [a.global.sellerid] : [], a.global.orderid = a.isArray(a.global.orderid) ? a.global.orderid : a.global.orderid.toString().indexOf(",") > -1 ? a.global.orderid.split(",") : a.global.orderid ? [a.global.orderid] : [], a.global.orderprice = a.isArray(a.global.orderprice) ? a.global.orderprice : a.global.orderprice.toString().indexOf(",") > -1 ? a.global.orderprice.split(",") : a.global.orderprice ? [a.global.orderprice] : [], a.inArray(a.global.siteid, c) > -1 && (a.global.shortid = a.global.uname || ""), !a.global.itemid && a.global.ntalkerparam && (a.isObject(a.global.ntalkerparam) || a.Log("ntalkerparam param abnormal", 2), a.global.ntalkerparam.item && (a.global.itemid = a.global.ntalkerparam.item.id)), /number|string/i.test(typeof a.global.shortid) && /string/i.test(typeof a.global.uname) || (a.Log("userid or username type error"), a.global.shortid = "", a.global.uname = ""), a.referrer = a.enCut(a.referrer, 255), a.global.settingid = a.global.settingid && /[a-z]{2}\_\d+\_\d+/gi.test(a.global.settingid) ? a.global.settingid : "", a.global.iconid = a.isNumeric(a.global.iconid) ? a.global.iconid : 0, a.global.title = a.enCut(a.title, 255), a.global.shortid = a.global.shortid && "0" != a.global.shortid ? a.enCut(a.global.shortid, 64 - a.enLength(a.global.siteid) - 10) : "", a.global.uname = !a.global.shortid || "0" == a.global.shortid || /^(undefined|null|0)$/gi.test(a.global.uname) ? "" : a.global.uname ? a.enCut(a.global.uname, 32) : a.enCut(a.global.shortid, 32), a.global.uid = this.toLongID(a.global.shortid), a.global.isvip = a.isNumeric(a.global.isvip) ? a.global.isvip : a.isNumeric(a.global.userlevel) ? a.global.userlevel : 0, a.global.userlevel = a.isNumeric(a.global.userlevel) ? a.global.userlevel : 0, a.inArray(a.global.siteid, c) > -1 && (a.global.shortid = a.global.uname || ""), a.global = this.filterJSONChar(a.global, ""), a.Log("global: " + a.JSON.toJSONString(a.global), 1), a.global)
                },
                _filterChar: function (b, c) {
                    var d, e, f = [];
                    c && a.each(this.entityList, function (a, c) {
                        try {
                            d = new RegExp(a, "gi"), b = b.replace(d, c)
                        } catch (e) {
                        }
                    });
                    for (var g = 0, h = b.length; g < h; g++)try {
                        e = encodeURIComponent(b.charAt(g)), f.push(b.charAt(g))
                    } catch (i) {
                        try {
                            e = encodeURIComponent(b.charAt(g) + b.charAt(g + 1)), f.push((f.length ? " " : "") + e.replace(/%/gi, "") + (g + 2 >= h ? "" : " ")), ++g
                        } catch (i) {
                            f.push(b.charAt(g))
                        }
                    }
                ...
                filterJSONChar: function (b, c) {
                    var d, e = this;
                    if (a.isObject(b)) d = {}, a.each(b, function (a, b) {
                        d[a] = e.filterJSONChar(b, a)
                    }); else if (a.isArray(b)) {
                        d = [];
                        for (var f = 0; f < b.length; f++)d[f] = this.filterJSONChar(b[f], f)
                    } else d = "string" == typeof b ? this._filterChar(b, a.inArray(c, this.fieldList) !== -1) : b;
                    return d
                },
                _loadIdentityID: function (b) {
                    var c, d, e = this, f = "";
                    "undefined" != typeof ntalker && ntalker.getIdentityID && (a.Log("get sdk pcid"), f = ntalker.getIdentityID()), a.Log("ntalker type : " + typeof ntalker), "" === f && (f = a.cookie.get(a.CON_PCID_KEY)), a.global.trailid = a.cache.get("tid"), this.userIdFix = a.global.siteid + "_ISME9754_", a.global.trailid && (d = Math.round((a.getTime() - +a.global.trailid.toString().substr(0, 13)) / 36e5), d >= 4 && (a.global.trailid = "")), (!a.global.trailid || a.url.indexOf("livecrmtest") > -1) && (a.global.trailid = a.getTime(2), a.base.clearChatCache = !0, a.flashData && a.flashData.clearAll()), f && f.length > 10 ? (c = a.global.uid && a.global.uid.indexOf(a.global.siteid) > -1 ? a.global.uid : this.userIdFix + f.substr(0, 21), a.Log("load PCID:" + f + ", uid:" + c), b.call(this, c, f)) : a.flash.support && !a.browser.mobile ? (this._createNTID({
                        u: a.global.uid,
                        siteid: a.global.siteid,
                        ...
                        a.global.connect = a.CON_CONNECT_COMET, a.Log("timeout:" + e.timeOut + " no create pcid", 2), b.call(e, c, f)
                    }, this.timeOut)) : a.cookie.enable() ? (f = this._createScriptPCID(!1), a.Log("create script PCID"), c = a.global.uid || this.userIdFix + f.substr(0, 21), b.call(this, c, f)) : a.require({Fingerprint2: "fingerprint2.js" + a.baseExt}, function (d) {
                        return a.Fingerprint2 ? (fingerprint2 = new a.Fingerprint2, void fingerprint2.get(function (d) {
                            f = "guest-Fin" + d, c = a.global.uid || e.userIdFix + f.substr(0, 21), b(c, f)
                        })) : void a.Log("load Fingerprint2 failure")
                    })
                },
                _createNTID: function (b) {
                    var c = a("#" + d), f = a.flashHtml(e, a.sourceURI + "fs/NTID.swf?" + a.version.ntid, b);
                    c.length || (c = a(document.body).insert('<div id="' + d + '" style="position: absolute; z-index: 9996; top: -200px;"></div>')), c.insert(f)
                },
                _createScriptPCID: function (b) {
                ...
                _loadFlashServer: function () {
                    a.Log("start load flashserver."), a.require({
                        ...
                        b = a.extend({}, g, b), a.server = a.protocolFilter(a.extend(a.server, b))
                    })
                }
            }, a.extend({
                _callFlashServer: function (b, c) {
                    a.flashserver = b, a.server = a.protocolFilter(a.extend(a.server, a.flashserver)), a.Log("$flashserver loading is complete. resultType:" + c)
                    ...
                    var c, d = a(".ntalk-mobile-iframe-window"), e = a("IFRAME[name=" + b + "]");
                    return d.length ? {created: !1, element: d} : (d = a({
                        ...
                        src: "about:blank"
                    }).appendTo(".ntalk-mobile-iframe-window"), a(window).bind("resize", function () {
                        a(e).css({
                            width: "100%",
                        ...
                        if (b && b.indexOf("destInfo") > -1 && "function" == typeof im_destUserInfo && 3 == b.split(",").length) {
                            var c = b.split(",")[1], e = b.split(",")[2];
                            im_destUserInfo({id: c, name: e})
                        }
                    }), {created: !0, element: d})
                ...
                im_openInPageChat: function (b, c, d, e, f) {
                    var g, h, i, j;
                    if (!a.base._startBase)return a.base.start(), void function () {
                        i = arguments, a.base._startBase ? a.im_openInPageChat(b, c, d, e, f) : setTimeout(function () {
                            i.callee()
                        }, 50)
                    }();
                    ...
                    if (a.invite && a.invite._close(), a.Log("nTalk.im_openInPageChat()", 1), b = b || a.global.settingid || "", g = a.global.settingid ? a.global.settingid.split("_").splice(0, 2).join("_") : "", h = b ? b.split("_").splice(0, 2).join("_") : "", j = a.global.sellerid && a.global.sellerid.length ? a.global.sellerid[0] : "", e = a.extend({}, e), c || (h && ("" === h || h != j && h != g) ? (c = "", f = "") : (c = a.global.itemid, f = a.global.itemparam)), j = h != a.global.siteid ? h : "", a.Log("settingId:" + b + ", itemId:" + c + ", itemparam:" + f), a.browser.mobile || a.global.pageinchat !== !0)return this.im_openOutPageChat(b, c, d, e, f);
                    2 != a.server.notrail || a.base.call_trail_status || (a.base.call_trail_status = !0, a.base.startTrail());
                    var k = e && e.single ? e.single : "", l = e && e.manual ? 1 : 0,
                        m = !(!e || !a.isDefined(e.autoconnect)) && e.autoconnect;
                    ...
                    a.Log("nTalk.im_openOutPageChat()", 1), b = b || a.global.settingid || "", g = a.global.settingid ? a.global.settingid.split("_").splice(0, 2).join("_") : "", h = b ? b.split("_").splice(0, 2).join("_") : "", j = a.global.sellerid && a.global.sellerid.length ? a.global.sellerid[0] : "", e = a.extend({}, e), c || (h && ("" === h || h != j && h != g) ? (c = "", f = "") : (c = a.global.itemid, f = a.global.itemparam)), j = h != a.global.siteid ? h : "", a.Log("settingId:" + b + ", itemId:" + c + ", itemparam:" + f);
                    var k, l = a.browser.mobile ? "_self" : "_blank", m = e && e.single ? e.single : "",
                        n = (e && e.manual ? 1 : 0, {
                            v: a.version.script,
                            siteid: a.global.siteid,
                            sellerid: j,
                    ...
                    if ("undefined" != typeof ntalker && ntalker.openChatWindow) {
                        sdkQuery = a.extend({}, n, o), sdkQuery.uid = a.base.toShortID(sdkQuery.uid), sdkQuery.flashserver = a.server.flashserver, a.Log("call ntalker.openChatWindow()", 2);
                    ...
                    return a.global.themes && (n.themes = a.global.themes), e.iframechat ? (l = "ntalk-mobile-chat", a.require({animate: "nt2.js" + a.baseExt}, function (b) {
                        return a.animate ? (k = a._createMobileIframeWindow(l), (!k || k && k.created === !0) && (a.objectPost = new a.POST(a.server.flashserver + "chat.php?" + a.toURI(n, !0, "&"), o, function () {
                            a.Log("open chat window complete", 1)
                        }, l)), void a._showMobileIframeWindow(k.element)) : void a.Log("Loaded $nt2 mode failed", 3)
                    }), null) : ((!k || k && k.created === !0) && (a.objectPost = new a.POST(a.server.flashserver + "chat.php?" + a.toURI(n, !0, "&"), o, function () {
                        a.Log("open chat window complete", 1)
                    }, l)), k ? k.element : a.objectPost.iframeElement)
                }, im_getAppChatWindowURL: function (b, c) {
                    var d, e, f, g, h, i, j, k, l;
                    if (!a.base._startBase)return a.base.start(), void function () {
                        f = arguments, a.base._startBase ? a.im_getAppChatWindowURL(b, c) : setTimeout(function () {
                            f.callee()
                        }, 50)
                    }();
                    if (a.base.chanageUserID())return void a.base.overloadedData(function () {
                    ...
                    a.Log("nTalk.im_getAppChatWindowURL()", 1), "function" == typeof b ? (c = b, b = {}) : b = a.extend({}, b), h = b.destid || "", i = b.settingId || a.global.settingid || "", d = a.global.settingid ? a.global.settingid.split("_").splice(0, 2).join("_") : "", e = b.settingid ? b.settingid.split("_").splice(0, 2).join("_") : "", g = a.global.sellerid && a.global.sellerid.length ? a.global.sellerid[0] : "", l = a.extend({}, b.options), b.itemid ? (j = b.itemid, k = b.itemparam) : e && ("" === e || e !== g && e !== d) ? (j = "", k = "") : (j = a.global.itemid, k = a.global.itemparam), g = e != a.global.siteid ? e : "", a.Log("settingId:" + i + ", itemId:" + j + ", itemparam:" + k);
                    var m = l && l.single ? l.single : "", n = (l && l.manual ? 1 : 0, {
                        v: a.version.script,
                        siteid: a.global.siteid,
                        sellerid: g,
                        settingid: i,
                    ...
                    a.referrer = a.url, a.title = b || document.title, a.url = c || document.location.href, a.base.overloadedData(d)
                }, t2d: {
                    openChatWindow: function (b, c, d) {
                        a.im_openOutPageChat(d, "", b, null, "")
                    }
                }, enableDebug: function () {
                    return a.cache.get("debug") || a.cache.set("debug", 2), a.mDebug || a.require({
        ...
        a.imageloading = a.sourceURI + "images/loading.gif", a.server = a.extend({}, a.protocolFilter(CON_SERVER)), a.version = a.extend({}, a.version, CON_VERSION), a.baseExt = "?siteid=" + (a.extParmas.siteid || "") + "&v=" + a.version.dir + "&t=" + a.version.release, parseFloat(a.params["ntalker-debug"]) > 0 || +a.cache.get("debug") > 0 ? a.require({
            mDebug: "debug.js" + a.baseExt,
            Window: "nt2.js" + a.baseExt
        }, function (b) {
            b && !b.error && (a.mDebug.initialize(), a.Log = a.mDebug.Log, a.debug = a.mDebug, a.base.start())
        }) : (a.Log = h, a.debug = {Log: a.Log}, a.base.start()), a.require(a.imageloading)
    }
}(nTalk);