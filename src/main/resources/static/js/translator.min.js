...
;var Translator = (function (i, d) {
    ...
    function m(C, s, z) {
        var p, x, v = [], B = [], w = C.split(Translator.pluralSeparator), u = [];
    ...
    return {
        ...
        add: function (u, s, t, q) {
            var r = q || this.locale || this.fallback, p = t || this.defaultDomain;
            if (!e[r]) {
                e[r] = {}
            }
            if (!e[r][p]) {
